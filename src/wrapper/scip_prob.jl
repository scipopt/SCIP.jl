...
function SCIPcreateProb(scip, name, probdelorig, probtrans, probdeltrans, probinitsol, probexitsol, probcopy, probdata)
    ccall((:SCIPcreateProb, libscip), SCIP_RETCODE, (Ptr{SCIP}, Cstring, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{SCIP_PROBDATA}), scip, name, probdelorig, probtrans, probdeltrans, probinitsol, probexitsol, probcopy, probdata)
end

function SCIPcreateProbBasic(scip, name)
    ccall((:SCIPcreateProbBasic, libscip), SCIP_RETCODE, (Ptr{SCIP}, Cstring), scip, name)
end
...
function SCIPgetProbName(scip)
    ccall((:SCIPgetProbName, libscip), Cstring, (Ptr{SCIP},), scip)
end
...
function SCIPisObjIntegral(scip)
    ccall((:SCIPisObjIntegral, libscip), UInt32, (Ptr{SCIP},), scip)
end
...
function SCIPdelVar(scip, var, deleted)
    ccall((:SCIPdelVar, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_VAR}, Ptr{UInt32}), scip, var, deleted)
end
...
function SCIPfindVar(scip, name)
    ccall((:SCIPfindVar, libscip), Ptr{SCIP_VAR}, (Ptr{SCIP}, Cstring), scip, name)
end

function SCIPallVarsInProb(scip)
    ccall((:SCIPallVarsInProb, libscip), UInt32, (Ptr{SCIP},), scip)
end
...
function SCIPfindOrigCons(scip, name)
    ccall((:SCIPfindOrigCons, libscip), Ptr{SCIP_CONS}, (Ptr{SCIP}, Cstring), scip, name)
end

function SCIPfindCons(scip, name)
    ccall((:SCIPfindCons, libscip), Ptr{SCIP_CONS}, (Ptr{SCIP}, Cstring), scip, name)
end
