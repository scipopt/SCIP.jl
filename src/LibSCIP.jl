...
const TPI_NONE = nothing

const NPARASCIP = nothing

const WITH_SCIPDEF = nothing

const SCIP_WITH_ZLIB = nothing

const SCIP_WITH_GMP = nothing

const SCIP_ROUNDING_FE = nothing
...
const SCIP_THREADSAFE_MESSAGEHDLRS = nothing
...
# Skipping MacroDefinition: SCIP_MAXMEMSIZE ( SIZE_MAX / 2 )
...
# Skipping MacroDefinition: SCIP_MEM_NOLIMIT ( SCIP_Longint ) ( SCIP_LONGINT_MAX >> 20 )
...
# Skipping MacroDefinition: SCIP_PRESOLTIMING_MAX ( SCIP_PRESOLTIMING_FAST | SCIP_PRESOLTIMING_MEDIUM | SCIP_PRESOLTIMING_EXHAUSTIVE | SCIP_PRESOLTIMING_FINAL )
...
# Skipping MacroDefinition: SCIP_PROPTIMING_ALWAYS ( SCIP_PROPTIMING_BEFORELP | SCIP_PROPTIMING_DURINGLPLOOP | SCIP_PROPTIMING_AFTERLPLOOP | SCIP_PROPTIMING_AFTERLPNODE )
...
# Skipping MacroDefinition: SCIP_HEURTIMING_AFTERNODE ( SCIP_HEURTIMING_AFTERLPNODE | SCIP_HEURTIMING_AFTERPSEUDONODE )

# Skipping MacroDefinition: SCIP_HEURTIMING_AFTERPLUNGE ( SCIP_HEURTIMING_AFTERLPPLUNGE | SCIP_HEURTIMING_AFTERPSEUDOPLUNGE )

# Skipping MacroDefinition: SCIP_EVENTTYPE_DISABLED UINT64_C ( 0x000000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_VARADDED UINT64_C ( 0x000000001 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_VARDELETED UINT64_C ( 0x000000002 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_VARFIXED UINT64_C ( 0x000000004 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_VARUNLOCKED UINT64_C ( 0x000000008 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_OBJCHANGED UINT64_C ( 0x000000010 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_GLBCHANGED UINT64_C ( 0x000000020 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_GUBCHANGED UINT64_C ( 0x000000040 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_LBTIGHTENED UINT64_C ( 0x000000080 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_LBRELAXED UINT64_C ( 0x000000100 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_UBTIGHTENED UINT64_C ( 0x000000200 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_UBRELAXED UINT64_C ( 0x000000400 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_GHOLEADDED UINT64_C ( 0x000000800 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_GHOLEREMOVED UINT64_C ( 0x000001000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_LHOLEADDED UINT64_C ( 0x000002000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_LHOLEREMOVED UINT64_C ( 0x000004000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_IMPLADDED UINT64_C ( 0x000008000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_TYPECHANGED UINT64_C ( 0x000010000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_PRESOLVEROUND UINT64_C ( 0x000020000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_NODEFOCUSED UINT64_C ( 0x000040000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_NODEFEASIBLE UINT64_C ( 0x000080000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_NODEINFEASIBLE UINT64_C ( 0x000100000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_NODEBRANCHED UINT64_C ( 0x000200000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_NODEDELETE UINT64_C ( 0x000400000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_FIRSTLPSOLVED UINT64_C ( 0x000800000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_LPSOLVED UINT64_C ( 0x001000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_POORSOLFOUND UINT64_C ( 0x002000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_BESTSOLFOUND UINT64_C ( 0x004000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_ROWADDEDSEPA UINT64_C ( 0x008000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_ROWDELETEDSEPA UINT64_C ( 0x010000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_ROWADDEDLP UINT64_C ( 0x020000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_ROWDELETEDLP UINT64_C ( 0x040000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_ROWCOEFCHANGED UINT64_C ( 0x080000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_ROWCONSTCHANGED UINT64_C ( 0x100000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_ROWSIDECHANGED UINT64_C ( 0x200000000 )

# Skipping MacroDefinition: SCIP_EVENTTYPE_SYNC UINT64_C ( 0x400000000 )
...
# Skipping MacroDefinition: SCIP_EVENTTYPE_VARCHANGED ( SCIP_EVENTTYPE_VARFIXED | SCIP_EVENTTYPE_VARUNLOCKED | SCIP_EVENTTYPE_OBJCHANGED | SCIP_EVENTTYPE_GBDCHANGED | SCIP_EVENTTYPE_DOMCHANGED | SCIP_EVENTTYPE_IMPLADDED | SCIP_EVENTTYPE_VARDELETED | SCIP_EVENTTYPE_TYPECHANGED )

# Skipping MacroDefinition: SCIP_EVENTTYPE_VAREVENT ( SCIP_EVENTTYPE_VARADDED | SCIP_EVENTTYPE_VARCHANGED | SCIP_EVENTTYPE_TYPECHANGED )
...
# Skipping MacroDefinition: SCIP_EVENTTYPE_NODEEVENT ( SCIP_EVENTTYPE_NODEFOCUSED | SCIP_EVENTTYPE_NODESOLVED )

# Skipping MacroDefinition: SCIP_EVENTTYPE_LPEVENT ( SCIP_EVENTTYPE_FIRSTLPSOLVED | SCIP_EVENTTYPE_LPSOLVED )
...
# Skipping MacroDefinition: SCIP_EVENTTYPE_ROWEVENT ( SCIP_EVENTTYPE_ROWADDEDSEPA | SCIP_EVENTTYPE_ROWDELETEDSEPA | SCIP_EVENTTYPE_ROWADDEDLP | SCIP_EVENTTYPE_ROWDELETEDLP | SCIP_EVENTTYPE_ROWCHANGED )
...
const SRC_SCIP_PUB_BANDIT_EPSGREEDY_H_ = nothing

const SRC_SCIP_PUB_BANDIT_EXP3_H_ = nothing

const SRC_SCIP_PUB_BANDIT_UCB_H_ = nothing

const SCIP_PUB_DECOMP_H_ = nothing

const SRC_SCIP_TYPE_DECOMP_H_ = nothing
...
# Skipping MacroDefinition: SCIP_EXPRINTCAPABILITY_ALL ( SCIP_EXPRINTCAPABILITY_FUNCVALUE | SCIP_EXPRINTCAPABILITY_INTFUNCVALUE | SCIP_EXPRINTCAPABILITY_GRADIENT | SCIP_EXPRINTCAPABILITY_INTGRADIENT | SCIP_EXPRINTCAPABILITY_HESSIAN | SCIP_EXPRINTCAPABILITY_INTHESSIAN )

const _SCIP_DBLDBL_ARITH_ = nothing

const QUAD_EPSILON = 1.0e-12

const SCIP_SCIP_DECOMP_H_ = nothing

const ARTIFICIALVARNAMEPREFIX = "andresultant_"

const HEUR_SUBNLP_H_ = nothing
...
# Skipping MacroDefinition: SCIP_EXPRBOUNDSTATUS_TIGHTENEDBYPARENTRECENT ( 0x8 | SCIP_EXPRBOUNDSTATUS_TIGHTENEDBYPARENT )

# Skipping MacroDefinition: SCIP_EXPRBOUNDSTATUS_TIGHTENEDBYPARENTFORCE ( 0x10 | SCIP_EXPRBOUNDSTATUS_TIGHTENEDBYPARENTRECENT )
