...
function SCIPcreateBanditEpsgreedy(scip, epsgreedy, priorities, eps, usemodification, preferrecent, decayfactor, avglim, nactions, initseed)
    ccall((:SCIPcreateBanditEpsgreedy, libscip), Cint, (Ptr{SCIP}, Ptr{Ptr{SCIP_BANDIT}}, Ptr{Cdouble}, Cdouble, Cuint, Cuint, Cdouble, Cint, Cint, Cuint), scip, epsgreedy, priorities, eps, usemodification, preferrecent, decayfactor, avglim, nactions, initseed)
end
...
function SCIPcreateBanditExp3IX(scip, exp3ix, priorities, nactions, initseed)
    ccall((:SCIPcreateBanditExp3IX, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_BANDIT}}, Ptr{Cdouble}, Cint, Cuint), scip, exp3ix, priorities, nactions, initseed)
end

function SCIPgetProbabilityExp3IX(exp3ix, action)
    ccall((:SCIPgetProbabilityExp3IX, libscip), Cdouble, (Ptr{SCIP_BANDIT}, Cint), exp3ix, action)
end
...
function SCIPintervalAreDisjointEps(eps, operand1, operand2)
    ccall((:SCIPintervalAreDisjointEps, libscip), Cuint, (Cdouble, SCIP_INTERVAL, SCIP_INTERVAL), eps, operand1, operand2)
end
...
function SCIPintervalIntersectEps(resultant, eps, operand1, operand2)
    ccall((:SCIPintervalIntersectEps, libscip), Cvoid, (Ptr{SCIP_INTERVAL}, Cdouble, SCIP_INTERVAL, SCIP_INTERVAL), resultant, eps, operand1, operand2)
end
...
function SCIPintervalEntropy(infinity, resultant, operand)
    ccall((:SCIPintervalEntropy, libscip), Cvoid, (Cdouble, Ptr{SCIP_INTERVAL}, SCIP_INTERVAL), infinity, resultant, operand)
end
...
function SCIPintervalPropagateWeightedSum(infinity, noperands, operands, weights, constant, rhs, resultants, infeasible)
    ccall((:SCIPintervalPropagateWeightedSum, libscip), Cint, (Cdouble, Cint, Ptr{SCIP_INTERVAL}, Ptr{Cdouble}, Cdouble, SCIP_INTERVAL, Ptr{SCIP_INTERVAL}, Ptr{Cuint}), infinity, noperands, operands, weights, constant, rhs, resultants, infeasible)
end
...
function SCIPbendersGetNLPParam(benders)
    ccall((:SCIPbendersGetNLPParam, libscip), SCIP_NLPPARAM, (Ptr{SCIP_BENDERS},), benders)
end
...
function SCIPbendersSubproblemsAreInfeasible(benders)
    ccall((:SCIPbendersSubproblemsAreInfeasible, libscip), Cuint, (Ptr{SCIP_BENDERS},), benders)
end
...
function SCIPconsCompCheck(elem1, elem2)
    ccall((:SCIPconsCompCheck, libscip), Cint, (Ptr{Cvoid}, Ptr{Cvoid}), elem1, elem2)
end
...
function SCIPconshdlrSupportsPermsymDetection(conshdlr)
    ccall((:SCIPconshdlrSupportsPermsymDetection, libscip), Cuint, (Ptr{SCIP_CONSHDLR},), conshdlr)
end

function SCIPconshdlrSupportsSignedPermsymDetection(conshdlr)
    ccall((:SCIPconshdlrSupportsSignedPermsymDetection, libscip), Cuint, (Ptr{SCIP_CONSHDLR},), conshdlr)
end
...
function SCIPcutpoolGetMaxNCuts(cutpool)
    ccall((:SCIPcutpoolGetMaxNCuts, libscip), Clonglong, (Ptr{SCIP_CUTPOOL},), cutpool)
end
...
function SCIPcutpoolGetNRootCalls(cutpool)
    ccall((:SCIPcutpoolGetNRootCalls, libscip), Clonglong, (Ptr{SCIP_CUTPOOL},), cutpool)
end
...
function SCIPcutpoolGetNCutsAdded(cutpool)
    ccall((:SCIPcutpoolGetNCutsAdded, libscip), Clonglong, (Ptr{SCIP_CUTPOOL},), cutpool)
end
...
function SCIPcutselGetName(cutsel)
    ccall((:SCIPcutselGetName, libscip), Ptr{Cchar}, (Ptr{SCIP_CUTSEL},), cutsel)
end
...
function SCIPcutselGetData(cutsel)
    ccall((:SCIPcutselGetData, libscip), Ptr{SCIP_CUTSELDATA}, (Ptr{SCIP_CUTSEL},), cutsel)
end

function SCIPcutselGetDesc(cutsel)
    ccall((:SCIPcutselGetDesc, libscip), Ptr{Cchar}, (Ptr{SCIP_CUTSEL},), cutsel)
end
...
function SCIPcutselSetData(cutsel, cutseldata)
    ccall((:SCIPcutselSetData, libscip), Cvoid, (Ptr{SCIP_CUTSEL}, Ptr{SCIP_CUTSELDATA}), cutsel, cutseldata)
end

function SCIPcutselIsInitialized(cutsel)
    ccall((:SCIPcutselIsInitialized, libscip), Cuint, (Ptr{SCIP_CUTSEL},), cutsel)
end

function SCIPcutselGetSetupTime(cutsel)
    ccall((:SCIPcutselGetSetupTime, libscip), Cdouble, (Ptr{SCIP_CUTSEL},), cutsel)
end
...
function SCIPcutselGetNCalls(cutsel)
    ccall((:SCIPcutselGetNCalls, libscip), Clonglong, (Ptr{SCIP_CUTSEL},), cutsel)
end

function SCIPcutselGetNRootCalls(cutsel)
    ccall((:SCIPcutselGetNRootCalls, libscip), Clonglong, (Ptr{SCIP_CUTSEL},), cutsel)
end

function SCIPcutselGetNRootCuts(cutsel)
    ccall((:SCIPcutselGetNRootCuts, libscip), Clonglong, (Ptr{SCIP_CUTSEL},), cutsel)
end

function SCIPcutselGetNRootForcedCuts(cutsel)
    ccall((:SCIPcutselGetNRootForcedCuts, libscip), Clonglong, (Ptr{SCIP_CUTSEL},), cutsel)
end

function SCIPcutselGetNRootCutsFiltered(cutsel)
    ccall((:SCIPcutselGetNRootCutsFiltered, libscip), Clonglong, (Ptr{SCIP_CUTSEL},), cutsel)
end

function SCIPcutselGetNLocalCuts(cutsel)
    ccall((:SCIPcutselGetNLocalCuts, libscip), Clonglong, (Ptr{SCIP_CUTSEL},), cutsel)
end

function SCIPcutselGetNLocalForcedCuts(cutsel)
    ccall((:SCIPcutselGetNLocalForcedCuts, libscip), Clonglong, (Ptr{SCIP_CUTSEL},), cutsel)
end

function SCIPcutselGetNLocalCutsFiltered(cutsel)
    ccall((:SCIPcutselGetNLocalCutsFiltered, libscip), Clonglong, (Ptr{SCIP_CUTSEL},), cutsel)
end

function SCIPcutselComp(elem1, elem2)
    ccall((:SCIPcutselComp, libscip), Cint, (Ptr{Cvoid}, Ptr{Cvoid}), elem1, elem2)
end
...
function SCIPdecompGetVarsSize(decomp, varssize, nblocks)
    ccall((:SCIPdecompGetVarsSize, libscip), SCIP_RETCODE, (Ptr{SCIP_DECOMP}, Ptr{Cint}, Cint), decomp, varssize, nblocks)
end

function SCIPdecompGetConssSize(decomp, consssize, nblocks)
    ccall((:SCIPdecompGetConssSize, libscip), SCIP_RETCODE, (Ptr{SCIP_DECOMP}, Ptr{Cint}, Cint), decomp, consssize, nblocks)
end

function SCIPdecompGetNBorderVars(decomp)
    ccall((:SCIPdecompGetNBorderVars, libscip), Cint, (Ptr{SCIP_DECOMP},), decomp)
end

function SCIPdecompGetNBorderConss(decomp)
    ccall((:SCIPdecompGetNBorderConss, libscip), Cint, (Ptr{SCIP_DECOMP},), decomp)
end
...
function SCIPexprhdlrSetCopyFreeData(exprhdlr, copydata, freedata)
    ccall((:SCIPexprhdlrSetCopyFreeData, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}, Ptr{Cvoid}), exprhdlr, copydata, freedata)
end

function SCIPexprhdlrSetPrint(exprhdlr, print)
    ccall((:SCIPexprhdlrSetPrint, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, print)
end

function SCIPexprhdlrSetParse(exprhdlr, parse)
    ccall((:SCIPexprhdlrSetParse, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, parse)
end

function SCIPexprhdlrSetCurvature(exprhdlr, curvature)
    ccall((:SCIPexprhdlrSetCurvature, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, curvature)
end

function SCIPexprhdlrSetMonotonicity(exprhdlr, monotonicity)
    ccall((:SCIPexprhdlrSetMonotonicity, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, monotonicity)
end

function SCIPexprhdlrSetIntegrality(exprhdlr, integrality)
    ccall((:SCIPexprhdlrSetIntegrality, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, integrality)
end

function SCIPexprhdlrSetHash(exprhdlr, hash)
    ccall((:SCIPexprhdlrSetHash, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, hash)
end

function SCIPexprhdlrSetCompare(exprhdlr, compare)
    ccall((:SCIPexprhdlrSetCompare, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, compare)
end

function SCIPexprhdlrSetDiff(exprhdlr, bwdiff, fwdiff, bwfwdiff)
    ccall((:SCIPexprhdlrSetDiff, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}), exprhdlr, bwdiff, fwdiff, bwfwdiff)
end

function SCIPexprhdlrSetIntEval(exprhdlr, inteval)
    ccall((:SCIPexprhdlrSetIntEval, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, inteval)
end

function SCIPexprhdlrSetSimplify(exprhdlr, simplify)
    ccall((:SCIPexprhdlrSetSimplify, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, simplify)
end

function SCIPexprhdlrSetReverseProp(exprhdlr, reverseprop)
    ccall((:SCIPexprhdlrSetReverseProp, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, reverseprop)
end

function SCIPexprhdlrSetEstimate(exprhdlr, initestimates, estimate)
    ccall((:SCIPexprhdlrSetEstimate, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}, Ptr{Cvoid}), exprhdlr, initestimates, estimate)
end

function SCIPexprhdlrSetGetSymdata(exprhdlr, getsymdata)
    ccall((:SCIPexprhdlrSetGetSymdata, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR}, Ptr{Cvoid}), exprhdlr, getsymdata)
end

function SCIPexprhdlrGetName(exprhdlr)
    ccall((:SCIPexprhdlrGetName, libscip), Ptr{Cchar}, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetDescription(exprhdlr)
    ccall((:SCIPexprhdlrGetDescription, libscip), Ptr{Cchar}, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetPrecedence(exprhdlr)
    ccall((:SCIPexprhdlrGetPrecedence, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end
...
function SCIPexprhdlrGetData(exprhdlr)
    ccall((:SCIPexprhdlrGetData, libscip), Ptr{SCIP_EXPRHDLRDATA}, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasPrint(exprhdlr)
    ccall((:SCIPexprhdlrHasPrint, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasBwdiff(exprhdlr)
    ccall((:SCIPexprhdlrHasBwdiff, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasFwdiff(exprhdlr)
    ccall((:SCIPexprhdlrHasFwdiff, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasIntEval(exprhdlr)
    ccall((:SCIPexprhdlrHasIntEval, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasEstimate(exprhdlr)
    ccall((:SCIPexprhdlrHasEstimate, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasInitEstimates(exprhdlr)
    ccall((:SCIPexprhdlrHasInitEstimates, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasSimplify(exprhdlr)
    ccall((:SCIPexprhdlrHasSimplify, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasCurvature(exprhdlr)
    ccall((:SCIPexprhdlrHasCurvature, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasMonotonicity(exprhdlr)
    ccall((:SCIPexprhdlrHasMonotonicity, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasReverseProp(exprhdlr)
    ccall((:SCIPexprhdlrHasReverseProp, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrHasGetSymData(exprhdlr)
    ccall((:SCIPexprhdlrHasGetSymData, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrComp(elem1, elem2)
    ccall((:SCIPexprhdlrComp, libscip), Cint, (Ptr{Cvoid}, Ptr{Cvoid}), elem1, elem2)
end

function SCIPexprhdlrGetNCreated(exprhdlr)
    ccall((:SCIPexprhdlrGetNCreated, libscip), Cuint, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetNIntevalCalls(exprhdlr)
    ccall((:SCIPexprhdlrGetNIntevalCalls, libscip), Clonglong, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetIntevalTime(exprhdlr)
    ccall((:SCIPexprhdlrGetIntevalTime, libscip), Cdouble, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetNReversepropCalls(exprhdlr)
    ccall((:SCIPexprhdlrGetNReversepropCalls, libscip), Clonglong, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetReversepropTime(exprhdlr)
    ccall((:SCIPexprhdlrGetReversepropTime, libscip), Cdouble, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetNCutoffs(exprhdlr)
    ccall((:SCIPexprhdlrGetNCutoffs, libscip), Clonglong, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetNDomainReductions(exprhdlr)
    ccall((:SCIPexprhdlrGetNDomainReductions, libscip), Clonglong, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end
...
function SCIPexprhdlrGetNEstimateCalls(exprhdlr)
    ccall((:SCIPexprhdlrGetNEstimateCalls, libscip), Clonglong, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetEstimateTime(exprhdlr)
    ccall((:SCIPexprhdlrGetEstimateTime, libscip), Cdouble, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetNBranchings(exprhdlr)
    ccall((:SCIPexprhdlrGetNBranchings, libscip), Clonglong, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrIncrementNBranchings(exprhdlr)
    ccall((:SCIPexprhdlrIncrementNBranchings, libscip), Cvoid, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetNSimplifyCalls(exprhdlr)
    ccall((:SCIPexprhdlrGetNSimplifyCalls, libscip), Clonglong, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetSimplifyTime(exprhdlr)
    ccall((:SCIPexprhdlrGetSimplifyTime, libscip), Cdouble, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end

function SCIPexprhdlrGetNSimplifications(exprhdlr)
    ccall((:SCIPexprhdlrGetNSimplifications, libscip), Clonglong, (Ptr{SCIP_EXPRHDLR},), exprhdlr)
end
...
function SCIPexprGetHdlr(expr)
    ccall((:SCIPexprGetHdlr, libscip), Ptr{SCIP_EXPRHDLR}, (Ptr{SCIP_EXPR},), expr)
end
...
function SCIPexprGetData(expr)
    ccall((:SCIPexprGetData, libscip), Ptr{SCIP_EXPRDATA}, (Ptr{SCIP_EXPR},), expr)
end

function SCIPexprSetData(expr, exprdata)
    ccall((:SCIPexprSetData, libscip), Cvoid, (Ptr{SCIP_EXPR}, Ptr{SCIP_EXPRDATA}), expr, exprdata)
end
...
function SCIPexprGetOwnerData(expr)
    ccall((:SCIPexprGetOwnerData, libscip), Ptr{SCIP_EXPR_OWNERDATA}, (Ptr{SCIP_EXPR},), expr)
end
...
function SCIPexprGetActivity(expr)
    ccall((:SCIPexprGetActivity, libscip), SCIP_INTERVAL, (Ptr{SCIP_EXPR},), expr)
end

function SCIPexprGetActivityTag(expr)
    ccall((:SCIPexprGetActivityTag, libscip), Clonglong, (Ptr{SCIP_EXPR},), expr)
end

function SCIPexprSetActivity(expr, activity, activitytag)
    ccall((:SCIPexprSetActivity, libscip), Cvoid, (Ptr{SCIP_EXPR}, SCIP_INTERVAL, Clonglong), expr, activity, activitytag)
end
...
function SCIPexprGetCurvature(expr)
    ccall((:SCIPexprGetCurvature, libscip), SCIP_EXPRCURV, (Ptr{SCIP_EXPR},), expr)
end

function SCIPexprSetCurvature(expr, curvature)
    ccall((:SCIPexprSetCurvature, libscip), Cvoid, (Ptr{SCIP_EXPR}, SCIP_EXPRCURV), expr, curvature)
end
...
function SCIPexprSetIntegrality(expr, isintegral)
    ccall((:SCIPexprSetIntegrality, libscip), Cvoid, (Ptr{SCIP_EXPR}, Cuint), expr, isintegral)
end

function SCIPexprGetQuadraticData(expr, constant, nlinexprs, linexprs, lincoefs, nquadexprs, nbilinexprs, eigenvalues, eigenvectors)
    ccall((:SCIPexprGetQuadraticData, libscip), Cvoid, (Ptr{SCIP_EXPR}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Ptr{Ptr{SCIP_EXPR}}}, Ptr{Ptr{Cdouble}}, Ptr{Cint}, Ptr{Cint}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cdouble}}), expr, constant, nlinexprs, linexprs, lincoefs, nquadexprs, nbilinexprs, eigenvalues, eigenvectors)
end

function SCIPexprGetQuadraticQuadTerm(quadexpr, termidx, expr, lincoef, sqrcoef, nadjbilin, adjbilin, sqrexpr)
    ccall((:SCIPexprGetQuadraticQuadTerm, libscip), Cvoid, (Ptr{SCIP_EXPR}, Cint, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Ptr{Cint}}, Ptr{Ptr{SCIP_EXPR}}), quadexpr, termidx, expr, lincoef, sqrcoef, nadjbilin, adjbilin, sqrexpr)
end

function SCIPexprGetQuadraticBilinTerm(expr, termidx, expr1, expr2, coef, pos2, prodexpr)
    ccall((:SCIPexprGetQuadraticBilinTerm, libscip), Cvoid, (Ptr{SCIP_EXPR}, Cint, Ptr{Ptr{SCIP_EXPR}}, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Ptr{SCIP_EXPR}}), expr, termidx, expr1, expr2, coef, pos2, prodexpr)
end

function SCIPexprAreQuadraticExprsVariables(expr)
    ccall((:SCIPexprAreQuadraticExprsVariables, libscip), Cuint, (Ptr{SCIP_EXPR},), expr)
end
...
function SCIPgetCoefsExprSum(expr)
    ccall((:SCIPgetCoefsExprSum, libscip), Ptr{Cdouble}, (Ptr{SCIP_EXPR},), expr)
end
...
function SCIPexpriterIsInit(iterator)
    ccall((:SCIPexpriterIsInit, libscip), Cuint, (Ptr{SCIP_EXPRITER},), iterator)
end
...
function SCIPexpriterInit(iterator, expr, type, allowrevisit)
    ccall((:SCIPexpriterInit, libscip), SCIP_RETCODE, (Ptr{SCIP_EXPRITER}, Ptr{SCIP_EXPR}, SCIP_EXPRITER_TYPE, Cuint), iterator, expr, type, allowrevisit)
end

function SCIPexpriterRestartDFS(iterator, expr)
    ccall((:SCIPexpriterRestartDFS, libscip), Ptr{SCIP_EXPR}, (Ptr{SCIP_EXPRITER}, Ptr{SCIP_EXPR}), iterator, expr)
end

const SCIP_EXPRITER_STAGE = Cuint

function SCIPexpriterSetStagesDFS(iterator, stopstages)
    ccall((:SCIPexpriterSetStagesDFS, libscip), Cvoid, (Ptr{SCIP_EXPRITER}, SCIP_EXPRITER_STAGE), iterator, stopstages)
end

function SCIPexpriterGetCurrent(iterator)
    ccall((:SCIPexpriterGetCurrent, libscip), Ptr{SCIP_EXPR}, (Ptr{SCIP_EXPRITER},), iterator)
end

function SCIPexpriterGetStageDFS(iterator)
    ccall((:SCIPexpriterGetStageDFS, libscip), SCIP_EXPRITER_STAGE, (Ptr{SCIP_EXPRITER},), iterator)
end

function SCIPexpriterGetChildIdxDFS(iterator)
    ccall((:SCIPexpriterGetChildIdxDFS, libscip), Cint, (Ptr{SCIP_EXPRITER},), iterator)
end

function SCIPexpriterGetChildExprDFS(iterator)
    ccall((:SCIPexpriterGetChildExprDFS, libscip), Ptr{SCIP_EXPR}, (Ptr{SCIP_EXPRITER},), iterator)
end

function SCIPexpriterGetParentDFS(iterator)
    ccall((:SCIPexpriterGetParentDFS, libscip), Ptr{SCIP_EXPR}, (Ptr{SCIP_EXPRITER},), iterator)
end
...
function SCIPexpriterGetCurrentUserData(iterator)
    ccall((:SCIPexpriterGetCurrentUserData, libscip), SCIP_EXPRITER_USERDATA, (Ptr{SCIP_EXPRITER},), iterator)
end

function SCIPexpriterGetChildUserDataDFS(iterator)
    ccall((:SCIPexpriterGetChildUserDataDFS, libscip), SCIP_EXPRITER_USERDATA, (Ptr{SCIP_EXPRITER},), iterator)
end

function SCIPexpriterGetExprUserData(iterator, expr)
    ccall((:SCIPexpriterGetExprUserData, libscip), SCIP_EXPRITER_USERDATA, (Ptr{SCIP_EXPRITER}, Ptr{SCIP_EXPR}), iterator, expr)
end

function SCIPexpriterSetCurrentUserData(iterator, userdata)
    ccall((:SCIPexpriterSetCurrentUserData, libscip), Cvoid, (Ptr{SCIP_EXPRITER}, SCIP_EXPRITER_USERDATA), iterator, userdata)
end

function SCIPexpriterSetExprUserData(iterator, expr, userdata)
    ccall((:SCIPexpriterSetExprUserData, libscip), Cvoid, (Ptr{SCIP_EXPRITER}, Ptr{SCIP_EXPR}, SCIP_EXPRITER_USERDATA), iterator, expr, userdata)
end

function SCIPexpriterSetChildUserData(iterator, userdata)
    ccall((:SCIPexpriterSetChildUserData, libscip), Cvoid, (Ptr{SCIP_EXPRITER}, SCIP_EXPRITER_USERDATA), iterator, userdata)
end

function SCIPexpriterGetNext(iterator)
    ccall((:SCIPexpriterGetNext, libscip), Ptr{SCIP_EXPR}, (Ptr{SCIP_EXPRITER},), iterator)
end

function SCIPexpriterSkipDFS(iterator)
    ccall((:SCIPexpriterSkipDFS, libscip), Ptr{SCIP_EXPR}, (Ptr{SCIP_EXPRITER},), iterator)
end
...
function SCIPexprcurvPowerInv(basebounds, exponent, powercurv)
    ccall((:SCIPexprcurvPowerInv, libscip), SCIP_EXPRCURV, (SCIP_INTERVAL, Cdouble, SCIP_EXPRCURV), basebounds, exponent, powercurv)
end
...
function SCIPexprcurvMonomialInv(monomialcurv, nfactors, exponents, factorbounds, factorcurv)
    ccall((:SCIPexprcurvMonomialInv, libscip), Cuint, (SCIP_EXPRCURV, Cint, Ptr{Cdouble}, Ptr{SCIP_INTERVAL}, Ptr{SCIP_EXPRCURV}), monomialcurv, nfactors, exponents, factorbounds, factorcurv)
end
...
function SCIPheurCompPriority(elem1, elem2)
    ccall((:SCIPheurCompPriority, libscip), Cint, (Ptr{Cvoid}, Ptr{Cvoid}), elem1, elem2)
end
...
function SCIPhistoryGetAvgConflictlength(history, dir)
    ccall((:SCIPhistoryGetAvgConflictlength, libscip), Cdouble, (Ptr{SCIP_HISTORY}, SCIP_BRANCHDIR), history, dir)
end
...
function SCIPhistoryGetInferenceSum(history, dir)
    ccall((:SCIPhistoryGetInferenceSum, libscip), Cdouble, (Ptr{SCIP_HISTORY}, SCIP_BRANCHDIR), history, dir)
end
...
function SCIPdotWriteNode(file, node, label, nodetype, fillcolor, bordercolor)
    ccall((:SCIPdotWriteNode, libscip), Cvoid, (Ptr{Libc.FILE}, Cint, Ptr{Cchar}, Ptr{Cchar}, Ptr{Cchar}, Ptr{Cchar}), file, node, label, nodetype, fillcolor, bordercolor)
end
...
function SCIPcalcRootNewton(_function, derivative, params, nparams, x, eps, k)
    ccall((:SCIPcalcRootNewton, libscip), Cdouble, (Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cdouble}, Cint, Cdouble, Cdouble, Cint), _function, derivative, params, nparams, x, eps, k)
end
...
function SCIPcomputeArraysIntersectionInt(array1, narray1, array2, narray2, intersectarray, nintersectarray)
    ccall((:SCIPcomputeArraysIntersectionInt, libscip), Cvoid, (Ptr{Cint}, Cint, Ptr{Cint}, Cint, Ptr{Cint}, Ptr{Cint}), array1, narray1, array2, narray2, intersectarray, nintersectarray)
end

function SCIPcomputeArraysIntersectionPtr(array1, narray1, array2, narray2, ptrcomp, intersectarray, nintersectarray)
    ccall((:SCIPcomputeArraysIntersectionPtr, libscip), Cvoid, (Ptr{Ptr{Cvoid}}, Cint, Ptr{Ptr{Cvoid}}, Cint, Ptr{Cvoid}, Ptr{Ptr{Cvoid}}, Ptr{Cint}), array1, narray1, array2, narray2, ptrcomp, intersectarray, nintersectarray)
end
...
function SCIPcomputeArraysSetminusInt(array1, narray1, array2, narray2, setminusarray, nsetminusarray)
    ccall((:SCIPcomputeArraysSetminusInt, libscip), Cvoid, (Ptr{Cint}, Cint, Ptr{Cint}, Cint, Ptr{Cint}, Ptr{Cint}), array1, narray1, array2, narray2, setminusarray, nsetminusarray)
end
...
function SCIPstrncasecmp(s1, s2, length)
    ccall((:SCIPstrncasecmp, libscip), Cint, (Ptr{Cchar}, Ptr{Cchar}, Cint), s1, s2, length)
end
...
function SCIPcreateRowprep(scip, rowprep, sidetype, _local)
    ccall((:SCIPcreateRowprep, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_ROWPREP}}, SCIP_SIDETYPE, Cuint), scip, rowprep, sidetype, _local)
end

function SCIPfreeRowprep(scip, rowprep)
    ccall((:SCIPfreeRowprep, libscip), Cvoid, (Ptr{SCIP}, Ptr{Ptr{SCIP_ROWPREP}}), scip, rowprep)
end

function SCIPcopyRowprep(scip, target, source)
    ccall((:SCIPcopyRowprep, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_ROWPREP}}, Ptr{SCIP_ROWPREP}), scip, target, source)
end
...
function SCIProwprepGetVars(rowprep)
    ccall((:SCIProwprepGetVars, libscip), Ptr{Ptr{SCIP_VAR}}, (Ptr{SCIP_ROWPREP},), rowprep)
end

function SCIProwprepGetCoefs(rowprep)
    ccall((:SCIProwprepGetCoefs, libscip), Ptr{Cdouble}, (Ptr{SCIP_ROWPREP},), rowprep)
end

function SCIProwprepGetSide(rowprep)
    ccall((:SCIProwprepGetSide, libscip), Cdouble, (Ptr{SCIP_ROWPREP},), rowprep)
end

function SCIProwprepGetSidetype(rowprep)
    ccall((:SCIProwprepGetSidetype, libscip), SCIP_SIDETYPE, (Ptr{SCIP_ROWPREP},), rowprep)
end
...
function SCIProwprepGetName(rowprep)
    ccall((:SCIProwprepGetName, libscip), Ptr{Cchar}, (Ptr{SCIP_ROWPREP},), rowprep)
end

function SCIProwprepGetNModifiedVars(rowprep)
    ccall((:SCIProwprepGetNModifiedVars, libscip), Cint, (Ptr{SCIP_ROWPREP},), rowprep)
end

function SCIProwprepGetModifiedVars(rowprep)
    ccall((:SCIProwprepGetModifiedVars, libscip), Ptr{Ptr{SCIP_VAR}}, (Ptr{SCIP_ROWPREP},), rowprep)
end
...
function SCIProwprepSetCoef(rowprep, idx, newcoef)
    ccall((:SCIProwprepSetCoef, libscip), Cvoid, (Ptr{SCIP_ROWPREP}, Cint, Cdouble), rowprep, idx, newcoef)
end

function SCIProwprepAddSide(rowprep, side)
    ccall((:SCIProwprepAddSide, libscip), Cvoid, (Ptr{SCIP_ROWPREP}, Cdouble), rowprep, side)
end

function SCIProwprepAddConstant(rowprep, constant)
    ccall((:SCIProwprepAddConstant, libscip), Cvoid, (Ptr{SCIP_ROWPREP}, Cdouble), rowprep, constant)
end
...
function SCIProwprepSetLocal(rowprep, islocal)
    ccall((:SCIProwprepSetLocal, libscip), Cvoid, (Ptr{SCIP_ROWPREP}, Cuint), rowprep, islocal)
end

function SCIProwprepRecordModifications(rowprep)
    ccall((:SCIProwprepRecordModifications, libscip), Cvoid, (Ptr{SCIP_ROWPREP},), rowprep)
end
...
function SCIPprintRowprepSol(scip, rowprep, sol, file)
    ccall((:SCIPprintRowprepSol, libscip), Cvoid, (Ptr{SCIP}, Ptr{SCIP_ROWPREP}, Ptr{SCIP_SOL}, Ptr{Libc.FILE}), scip, rowprep, sol, file)
end

function SCIPensureRowprepSize(scip, rowprep, size)
    ccall((:SCIPensureRowprepSize, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_ROWPREP}, Cint), scip, rowprep, size)
end

function SCIPaddRowprepTerm(scip, rowprep, var, coef)
    ccall((:SCIPaddRowprepTerm, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_ROWPREP}, Ptr{SCIP_VAR}, Cdouble), scip, rowprep, var, coef)
end

function SCIPaddRowprepTerms(scip, rowprep, nvars, vars, coefs)
    ccall((:SCIPaddRowprepTerms, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_ROWPREP}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}), scip, rowprep, nvars, vars, coefs)
end

function SCIPgetRowprepViolation(scip, rowprep, sol, reliable)
    ccall((:SCIPgetRowprepViolation, libscip), Cdouble, (Ptr{SCIP}, Ptr{SCIP_ROWPREP}, Ptr{SCIP_SOL}, Ptr{Cuint}), scip, rowprep, sol, reliable)
end

function SCIPisRowprepViolationReliable(scip, rowprep, sol)
    ccall((:SCIPisRowprepViolationReliable, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_ROWPREP}, Ptr{SCIP_SOL}), scip, rowprep, sol)
end

function SCIPmergeRowprepTerms(scip, rowprep)
    ccall((:SCIPmergeRowprepTerms, libscip), Cvoid, (Ptr{SCIP}, Ptr{SCIP_ROWPREP}), scip, rowprep)
end

function SCIPcleanupRowprep(scip, rowprep, sol, minviol, viol, success)
    ccall((:SCIPcleanupRowprep, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_ROWPREP}, Ptr{SCIP_SOL}, Cdouble, Ptr{Cdouble}, Ptr{Cuint}), scip, rowprep, sol, minviol, viol, success)
end

function SCIPcleanupRowprep2(scip, rowprep, sol, maxcoefbound, success)
    ccall((:SCIPcleanupRowprep2, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_ROWPREP}, Ptr{SCIP_SOL}, Cdouble, Ptr{Cuint}), scip, rowprep, sol, maxcoefbound, success)
end

function SCIPscaleupRowprep(scip, rowprep, minscaleup, success)
    ccall((:SCIPscaleupRowprep, libscip), Cdouble, (Ptr{SCIP}, Ptr{SCIP_ROWPREP}, Cdouble, Ptr{Cuint}), scip, rowprep, minscaleup, success)
end

function SCIPscaleRowprep(rowprep, factor)
    ccall((:SCIPscaleRowprep, libscip), Cint, (Ptr{SCIP_ROWPREP}, Cdouble), rowprep, factor)
end

function SCIPgetRowprepRowConshdlr(scip, row, rowprep, conshdlr)
    ccall((:SCIPgetRowprepRowConshdlr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_ROW}}, Ptr{SCIP_ROWPREP}, Ptr{SCIP_CONSHDLR}), scip, row, rowprep, conshdlr)
end

function SCIPgetRowprepRowCons(scip, row, rowprep, cons)
    ccall((:SCIPgetRowprepRowCons, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_ROW}}, Ptr{SCIP_ROWPREP}, Ptr{SCIP_CONS}), scip, row, rowprep, cons)
end

function SCIPgetRowprepRowSepa(scip, row, rowprep, sepa)
    ccall((:SCIPgetRowprepRowSepa, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_ROW}}, Ptr{SCIP_ROWPREP}, Ptr{SCIP_SEPA}), scip, row, rowprep, sepa)
end
...
function SCIPsortArgsortInt(dataptr, ind1, ind2)
    ccall((:SCIPsortArgsortInt, libscip), Cint, (Ptr{Cvoid}, Cint, Cint), dataptr, ind1, ind2)
end

function SCIPsortArgsortPtr(dataptr, ind1, ind2)
    ccall((:SCIPsortArgsortPtr, libscip), Cint, (Ptr{Cvoid}, Cint, Cint), dataptr, ind1, ind2)
end
...
function SCIPnlhdlrSetCopyHdlr(nlhdlr, copy)
    ccall((:SCIPnlhdlrSetCopyHdlr, libscip), Cvoid, (Ptr{SCIP_NLHDLR}, Ptr{Cvoid}), nlhdlr, copy)
end

function SCIPnlhdlrSetFreeHdlrData(nlhdlr, freehdlrdata)
    ccall((:SCIPnlhdlrSetFreeHdlrData, libscip), Cvoid, (Ptr{SCIP_NLHDLR}, Ptr{Cvoid}), nlhdlr, freehdlrdata)
end

function SCIPnlhdlrSetFreeExprData(nlhdlr, freeexprdata)
    ccall((:SCIPnlhdlrSetFreeExprData, libscip), Cvoid, (Ptr{SCIP_NLHDLR}, Ptr{Cvoid}), nlhdlr, freeexprdata)
end

function SCIPnlhdlrSetInitExit(nlhdlr, init, exit)
    ccall((:SCIPnlhdlrSetInitExit, libscip), Cvoid, (Ptr{SCIP_NLHDLR}, Ptr{Cvoid}, Ptr{Cvoid}), nlhdlr, init, exit)
end

function SCIPnlhdlrSetProp(nlhdlr, inteval, reverseprop)
    ccall((:SCIPnlhdlrSetProp, libscip), Cvoid, (Ptr{SCIP_NLHDLR}, Ptr{Cvoid}, Ptr{Cvoid}), nlhdlr, inteval, reverseprop)
end

function SCIPnlhdlrSetSepa(nlhdlr, initsepa, enfo, estimate, exitsepa)
    ccall((:SCIPnlhdlrSetSepa, libscip), Cvoid, (Ptr{SCIP_NLHDLR}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}), nlhdlr, initsepa, enfo, estimate, exitsepa)
end

function SCIPnlhdlrSetSollinearize(nlhdlr, sollinearize)
    ccall((:SCIPnlhdlrSetSollinearize, libscip), Cvoid, (Ptr{SCIP_NLHDLR}, Ptr{Cvoid}), nlhdlr, sollinearize)
end

function SCIPnlhdlrGetName(nlhdlr)
    ccall((:SCIPnlhdlrGetName, libscip), Ptr{Cchar}, (Ptr{SCIP_NLHDLR},), nlhdlr)
end

function SCIPnlhdlrGetDesc(nlhdlr)
    ccall((:SCIPnlhdlrGetDesc, libscip), Ptr{Cchar}, (Ptr{SCIP_NLHDLR},), nlhdlr)
end

function SCIPnlhdlrGetDetectPriority(nlhdlr)
    ccall((:SCIPnlhdlrGetDetectPriority, libscip), Cint, (Ptr{SCIP_NLHDLR},), nlhdlr)
end

function SCIPnlhdlrGetEnfoPriority(nlhdlr)
    ccall((:SCIPnlhdlrGetEnfoPriority, libscip), Cint, (Ptr{SCIP_NLHDLR},), nlhdlr)
end
...
function SCIPnlhdlrGetData(nlhdlr)
    ccall((:SCIPnlhdlrGetData, libscip), Ptr{SCIP_NLHDLRDATA}, (Ptr{SCIP_NLHDLR},), nlhdlr)
end
...
function SCIPnlhdlrHasReverseProp(nlhdlr)
    ccall((:SCIPnlhdlrHasReverseProp, libscip), Cuint, (Ptr{SCIP_NLHDLR},), nlhdlr)
end
...
function SCIPnlhdlrHasSollinearize(nlhdlr)
    ccall((:SCIPnlhdlrHasSollinearize, libscip), Cuint, (Ptr{SCIP_NLHDLR},), nlhdlr)
end

function SCIPnlhdlrComp(elem1, elem2)
    ccall((:SCIPnlhdlrComp, libscip), Cint, (Ptr{Cvoid}, Ptr{Cvoid}), elem1, elem2)
end
...
function SCIPnlrowGetExpr(nlrow)
    ccall((:SCIPnlrowGetExpr, libscip), Ptr{SCIP_EXPR}, (Ptr{SCIP_NLROW},), nlrow)
end
...
function SCIPnlpiComp(elem1, elem2)
    ccall((:SCIPnlpiComp, libscip), Cint, (Ptr{Cvoid}, Ptr{Cvoid}), elem1, elem2)
end
...
function SCIPnlpiGetData(nlpi)
    ccall((:SCIPnlpiGetData, libscip), Ptr{SCIP_NLPIDATA}, (Ptr{SCIP_NLPI},), nlpi)
end
...
function SCIPnlpiGetNIterations(nlpi)
    ccall((:SCIPnlpiGetNIterations, libscip), Clonglong, (Ptr{SCIP_NLPI},), nlpi)
end
...
function SCIPnlpiGetNTermStat(nlpi, termstatus)
    ccall((:SCIPnlpiGetNTermStat, libscip), Cint, (Ptr{SCIP_NLPI}, SCIP_NLPTERMSTAT), nlpi, termstatus)
end
...
function SCIPnlpiGetNSolStat(nlpi, solstatus)
    ccall((:SCIPnlpiGetNSolStat, libscip), Cint, (Ptr{SCIP_NLPI}, SCIP_NLPSOLSTAT), nlpi, solstatus)
end

function SCIPnlpiMergeStatistics(targetnlpi, sourcenlpi, reset)
    ccall((:SCIPnlpiMergeStatistics, libscip), Cvoid, (Ptr{SCIP_NLPI}, Ptr{SCIP_NLPI}, Cuint), targetnlpi, sourcenlpi, reset)
end
...
function SCIPsepaGetNCutsAddedViaPool(sepa)
    ccall((:SCIPsepaGetNCutsAddedViaPool, libscip), Clonglong, (Ptr{SCIP_SEPA},), sepa)
end

function SCIPsepaGetNCutsAddedDirect(sepa)
    ccall((:SCIPsepaGetNCutsAddedDirect, libscip), Clonglong, (Ptr{SCIP_SEPA},), sepa)
end
...
function SCIPsepaGetNCutsAppliedViaPool(sepa)
    ccall((:SCIPsepaGetNCutsAppliedViaPool, libscip), Clonglong, (Ptr{SCIP_SEPA},), sepa)
end

function SCIPsepaGetNCutsAppliedDirect(sepa)
    ccall((:SCIPsepaGetNCutsAppliedDirect, libscip), Clonglong, (Ptr{SCIP_SEPA},), sepa)
end
...
function SCIPsepaGetParentsepa(sepa)
    ccall((:SCIPsepaGetParentsepa, libscip), Ptr{SCIP_SEPA}, (Ptr{SCIP_SEPA},), sepa)
end
...
function SCIPvarGetImplicVarBounds(var, varfixing, implvar, lb, ub)
    ccall((:SCIPvarGetImplicVarBounds, libscip), Cvoid, (Ptr{SCIP_VAR}, Cuint, Ptr{SCIP_VAR}, Ptr{Cdouble}, Ptr{Cdouble}), var, varfixing, implvar, lb, ub)
end
...
function SCIPnlpiGetSolverPointer(set, nlpi, problem)
    ccall((:SCIPnlpiGetSolverPointer, libscip), Ptr{Cvoid}, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}), set, nlpi, problem)
end

function SCIPnlpiCreateProblem(set, nlpi, problem, name)
    ccall((:SCIPnlpiCreateProblem, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{Ptr{SCIP_NLPIPROBLEM}}, Ptr{Cchar}), set, nlpi, problem, name)
end

function SCIPnlpiFreeProblem(set, nlpi, problem)
    ccall((:SCIPnlpiFreeProblem, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{Ptr{SCIP_NLPIPROBLEM}}), set, nlpi, problem)
end

function SCIPnlpiGetProblemPointer(set, nlpi, problem)
    ccall((:SCIPnlpiGetProblemPointer, libscip), Ptr{Cvoid}, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}), set, nlpi, problem)
end

function SCIPnlpiAddVars(set, nlpi, problem, nvars, lbs, ubs, varnames)
    ccall((:SCIPnlpiAddVars, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Ptr{Cchar}}), set, nlpi, problem, nvars, lbs, ubs, varnames)
end

function SCIPnlpiAddConstraints(set, nlpi, problem, nconss, lhss, rhss, nlininds, lininds, linvals, exprs, names)
    ccall((:SCIPnlpiAddConstraints, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Ptr{Cint}}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{SCIP_EXPR}}, Ptr{Ptr{Cchar}}), set, nlpi, problem, nconss, lhss, rhss, nlininds, lininds, linvals, exprs, names)
end

function SCIPnlpiSetObjective(set, nlpi, problem, nlins, lininds, linvals, expr, constant)
    ccall((:SCIPnlpiSetObjective, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{Cint}, Ptr{Cdouble}, Ptr{SCIP_EXPR}, Cdouble), set, nlpi, problem, nlins, lininds, linvals, expr, constant)
end

function SCIPnlpiChgVarBounds(set, nlpi, problem, nvars, indices, lbs, ubs)
    ccall((:SCIPnlpiChgVarBounds, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}), set, nlpi, problem, nvars, indices, lbs, ubs)
end

function SCIPnlpiChgConsSides(set, nlpi, problem, nconss, indices, lhss, rhss)
    ccall((:SCIPnlpiChgConsSides, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}), set, nlpi, problem, nconss, indices, lhss, rhss)
end

function SCIPnlpiDelVarSet(set, nlpi, problem, dstats, dstatssize)
    ccall((:SCIPnlpiDelVarSet, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{Cint}, Cint), set, nlpi, problem, dstats, dstatssize)
end

function SCIPnlpiDelConsSet(set, nlpi, problem, dstats, dstatssize)
    ccall((:SCIPnlpiDelConsSet, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{Cint}, Cint), set, nlpi, problem, dstats, dstatssize)
end

function SCIPnlpiChgLinearCoefs(set, nlpi, problem, idx, nvals, varidxs, vals)
    ccall((:SCIPnlpiChgLinearCoefs, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Cint, Ptr{Cint}, Ptr{Cdouble}), set, nlpi, problem, idx, nvals, varidxs, vals)
end

function SCIPnlpiChgExpr(set, nlpi, problem, idxcons, expr)
    ccall((:SCIPnlpiChgExpr, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{SCIP_EXPR}), set, nlpi, problem, idxcons, expr)
end

function SCIPnlpiChgObjConstant(set, nlpi, problem, objconstant)
    ccall((:SCIPnlpiChgObjConstant, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cdouble), set, nlpi, problem, objconstant)
end

function SCIPnlpiSetInitialGuess(set, nlpi, problem, primalvalues, consdualvalues, varlbdualvalues, varubdualvalues)
    ccall((:SCIPnlpiSetInitialGuess, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), set, nlpi, problem, primalvalues, consdualvalues, varlbdualvalues, varubdualvalues)
end

function SCIPnlpiSolve(set, stat, nlpi, problem, param)
    ccall((:SCIPnlpiSolve, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_STAT}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{SCIP_NLPPARAM}), set, stat, nlpi, problem, param)
end

function SCIPnlpiGetSolstat(set, nlpi, problem)
    ccall((:SCIPnlpiGetSolstat, libscip), SCIP_NLPSOLSTAT, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}), set, nlpi, problem)
end

function SCIPnlpiGetTermstat(set, nlpi, problem)
    ccall((:SCIPnlpiGetTermstat, libscip), SCIP_NLPTERMSTAT, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}), set, nlpi, problem)
end

function SCIPnlpiGetSolution(set, nlpi, problem, primalvalues, consdualvalues, varlbdualvalues, varubdualvalues, objval)
    ccall((:SCIPnlpiGetSolution, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cdouble}}, Ptr{Cdouble}), set, nlpi, problem, primalvalues, consdualvalues, varlbdualvalues, varubdualvalues, objval)
end

function SCIPnlpiGetStatistics(set, nlpi, problem, statistics)
    ccall((:SCIPnlpiGetStatistics, libscip), SCIP_RETCODE, (Ptr{SCIP_SET}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{SCIP_NLPSTATISTICS}), set, nlpi, problem, statistics)
end
...
function BMSallocClearBlockMemory_call(blkmem, size, filename, line)
    ccall((:BMSallocClearBlockMemory_call, libscip), Ptr{Cvoid}, (Ptr{BMS_BLKMEM}, Csize_t, Ptr{Cchar}, Cint), blkmem, size, filename, line)
end
...
function SCIPsolveNLPParam(scip, param)
    ccall((:SCIPsolveNLPParam, libscip), SCIP_RETCODE, (Ptr{SCIP}, SCIP_NLPPARAM), scip, param)
end

function SCIPsolveNlpiParam(scip, nlpi, problem, param)
    ccall((:SCIPsolveNlpiParam, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, SCIP_NLPPARAM), scip, nlpi, problem, param)
end
...
function SCIPcalcKnapsackCover(scip, sol, allowlocal, aggrrow, cutcoefs, cutrhs, cutinds, cutnnz, cutefficacy, cutrank, cutislocal, success)
    ccall((:SCIPcalcKnapsackCover, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_SOL}, Cuint, Ptr{SCIP_AGGRROW}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cuint}, Ptr{Cuint}), scip, sol, allowlocal, aggrrow, cutcoefs, cutrhs, cutinds, cutnnz, cutefficacy, cutrank, cutislocal, success)
end
...
function SCIPperformGenericDivingAlgorithm(scip, diveset, worksol, heur, result, nodeinfeasible, iterlim, nodelimit, lpresolvedomchgquot, divecontext)
    ccall((:SCIPperformGenericDivingAlgorithm, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIVESET}, Ptr{SCIP_SOL}, Ptr{SCIP_HEUR}, Ptr{SCIP_RESULT}, Cuint, Clonglong, Cint, Cdouble, SCIP_DIVECONTEXT), scip, diveset, worksol, heur, result, nodeinfeasible, iterlim, nodelimit, lpresolvedomchgquot, divecontext)
end
...
function SCIPsetConshdlrGetPermsymGraph(scip, conshdlr, consgetpermsymgraph)
    ccall((:SCIPsetConshdlrGetPermsymGraph, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONSHDLR}, Ptr{Cvoid}), scip, conshdlr, consgetpermsymgraph)
end

function SCIPsetConshdlrGetSignedPermsymGraph(scip, conshdlr, consgetsignedpermsymgraph)
    ccall((:SCIPsetConshdlrGetSignedPermsymGraph, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONSHDLR}, Ptr{Cvoid}), scip, conshdlr, consgetsignedpermsymgraph)
end
...
function SCIPgetConsPermsymGraph(scip, cons, graph, success)
    ccall((:SCIPgetConsPermsymGraph, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{SYM_GRAPH}, Ptr{Cuint}), scip, cons, graph, success)
end

function SCIPgetConsSignedPermsymGraph(scip, cons, graph, success)
    ccall((:SCIPgetConsSignedPermsymGraph, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{SYM_GRAPH}, Ptr{Cuint}), scip, cons, graph, success)
end
...
function SCIPmergeNLPIStatistics(sourcescip, targetscip, reset)
    ccall((:SCIPmergeNLPIStatistics, libscip), Cvoid, (Ptr{SCIP}, Ptr{SCIP}, Cuint), sourcescip, targetscip, reset)
end
...
function SCIPgetCutLPSolCutoffDistance(scip, sol, cut)
    ccall((:SCIPgetCutLPSolCutoffDistance, libscip), Cdouble, (Ptr{SCIP}, Ptr{SCIP_SOL}, Ptr{SCIP_ROW}), scip, sol, cut)
end
...
function SCIPseparateSolCutpool(scip, cutpool, sol, pretendroot, result)
    ccall((:SCIPseparateSolCutpool, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CUTPOOL}, Ptr{SCIP_SOL}, Cuint, Ptr{SCIP_RESULT}), scip, cutpool, sol, pretendroot, result)
end
...
function SCIPincludeExprhdlr(scip, exprhdlr, name, desc, precedence, eval, data)
    ccall((:SCIPincludeExprhdlr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPRHDLR}}, Ptr{Cchar}, Ptr{Cchar}, Cuint, Ptr{Cvoid}, Ptr{SCIP_EXPRHDLRDATA}), scip, exprhdlr, name, desc, precedence, eval, data)
end

function SCIPgetExprhdlrs(scip)
    ccall((:SCIPgetExprhdlrs, libscip), Ptr{Ptr{SCIP_EXPRHDLR}}, (Ptr{SCIP},), scip)
end
...
function SCIPfindExprhdlr(scip, name)
    ccall((:SCIPfindExprhdlr, libscip), Ptr{SCIP_EXPRHDLR}, (Ptr{SCIP}, Ptr{Cchar}), scip, name)
end

function SCIPgetExprhdlrVar(scip)
    ccall((:SCIPgetExprhdlrVar, libscip), Ptr{SCIP_EXPRHDLR}, (Ptr{SCIP},), scip)
end

function SCIPgetExprhdlrValue(scip)
    ccall((:SCIPgetExprhdlrValue, libscip), Ptr{SCIP_EXPRHDLR}, (Ptr{SCIP},), scip)
end

function SCIPgetExprhdlrSum(scip)
    ccall((:SCIPgetExprhdlrSum, libscip), Ptr{SCIP_EXPRHDLR}, (Ptr{SCIP},), scip)
end

function SCIPgetExprhdlrProduct(scip)
    ccall((:SCIPgetExprhdlrProduct, libscip), Ptr{SCIP_EXPRHDLR}, (Ptr{SCIP},), scip)
end

function SCIPgetExprhdlrPower(scip)
    ccall((:SCIPgetExprhdlrPower, libscip), Ptr{SCIP_EXPRHDLR}, (Ptr{SCIP},), scip)
end

function SCIPcreateExpr(scip, expr, exprhdlr, exprdata, nchildren, children, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPRHDLR}, Ptr{SCIP_EXPRDATA}, Cint, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, exprhdlr, exprdata, nchildren, children, ownercreate, ownercreatedata)
end

function SCIPcreateExpr2(scip, expr, exprhdlr, exprdata, child1, child2, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExpr2, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPRHDLR}, Ptr{SCIP_EXPRDATA}, Ptr{SCIP_EXPR}, Ptr{SCIP_EXPR}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, exprhdlr, exprdata, child1, child2, ownercreate, ownercreatedata)
end

function SCIPcreateExprQuadratic(scip, expr, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoefs, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprQuadratic, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoefs, ownercreate, ownercreatedata)
end

function SCIPcreateExprMonomial(scip, expr, nfactors, vars, exponents, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprMonomial, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, nfactors, vars, exponents, ownercreate, ownercreatedata)
end

function SCIPappendExprChild(scip, expr, child)
    ccall((:SCIPappendExprChild, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_EXPR}), scip, expr, child)
end

function SCIPreplaceExprChild(scip, expr, childidx, newchild)
    ccall((:SCIPreplaceExprChild, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Cint, Ptr{SCIP_EXPR}), scip, expr, childidx, newchild)
end

function SCIPremoveExprChildren(scip, expr)
    ccall((:SCIPremoveExprChildren, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPduplicateExpr(scip, expr, copyexpr, mapexpr, mapexprdata, ownercreate, ownercreatedata)
    ccall((:SCIPduplicateExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, copyexpr, mapexpr, mapexprdata, ownercreate, ownercreatedata)
end

function SCIPduplicateExprShallow(scip, expr, copyexpr, ownercreate, ownercreatedata)
    ccall((:SCIPduplicateExprShallow, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, copyexpr, ownercreate, ownercreatedata)
end

function SCIPcopyExpr(sourcescip, targetscip, expr, copyexpr, ownercreate, ownercreatedata, varmap, consmap, _global, valid)
    ccall((:SCIPcopyExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{SCIP_HASHMAP}, Ptr{SCIP_HASHMAP}, Cuint, Ptr{Cuint}), sourcescip, targetscip, expr, copyexpr, ownercreate, ownercreatedata, varmap, consmap, _global, valid)
end

function SCIPparseExpr(scip, expr, exprstr, finalpos, ownercreate, ownercreatedata)
    ccall((:SCIPparseExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cchar}, Ptr{Ptr{Cchar}}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, exprstr, finalpos, ownercreate, ownercreatedata)
end
...
function SCIPreleaseExpr(scip, expr)
    ccall((:SCIPreleaseExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}), scip, expr)
end

function SCIPisExprVar(scip, expr)
    ccall((:SCIPisExprVar, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPisExprValue(scip, expr)
    ccall((:SCIPisExprValue, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPisExprSum(scip, expr)
    ccall((:SCIPisExprSum, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPisExprProduct(scip, expr)
    ccall((:SCIPisExprProduct, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPisExprPower(scip, expr)
    ccall((:SCIPisExprPower, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPprintExpr(scip, expr, file)
    ccall((:SCIPprintExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Libc.FILE}), scip, expr, file)
end

function SCIPprintExprDotInit(scip, printdata, file, whattoprint)
    ccall((:SCIPprintExprDotInit, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPRPRINTDATA}}, Ptr{Libc.FILE}, SCIP_EXPRPRINT_WHAT), scip, printdata, file, whattoprint)
end

function SCIPprintExprDotInit2(scip, printdata, filename, whattoprint)
    ccall((:SCIPprintExprDotInit2, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPRPRINTDATA}}, Ptr{Cchar}, SCIP_EXPRPRINT_WHAT), scip, printdata, filename, whattoprint)
end

function SCIPprintExprDot(scip, printdata, expr)
    ccall((:SCIPprintExprDot, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPRPRINTDATA}, Ptr{SCIP_EXPR}), scip, printdata, expr)
end

function SCIPprintExprDotFinal(scip, printdata)
    ccall((:SCIPprintExprDotFinal, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPRPRINTDATA}}), scip, printdata)
end

function SCIPshowExpr(scip, expr)
    ccall((:SCIPshowExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPdismantleExpr(scip, file, expr)
    ccall((:SCIPdismantleExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Libc.FILE}, Ptr{SCIP_EXPR}), scip, file, expr)
end

function SCIPevalExpr(scip, expr, sol, soltag)
    ccall((:SCIPevalExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_SOL}, Clonglong), scip, expr, sol, soltag)
end
...
function SCIPevalExprGradient(scip, expr, sol, soltag)
    ccall((:SCIPevalExprGradient, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_SOL}, Clonglong), scip, expr, sol, soltag)
end

function SCIPevalExprHessianDir(scip, expr, sol, soltag, direction)
    ccall((:SCIPevalExprHessianDir, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_SOL}, Clonglong, Ptr{SCIP_SOL}), scip, expr, sol, soltag, direction)
end

function SCIPevalExprActivity(scip, expr)
    ccall((:SCIPevalExprActivity, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPcompareExpr(scip, expr1, expr2)
    ccall((:SCIPcompareExpr, libscip), Cint, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_EXPR}), scip, expr1, expr2)
end

function SCIPhashExpr(scip, expr, hashval)
    ccall((:SCIPhashExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Cuint}), scip, expr, hashval)
end

function SCIPsimplifyExpr(scip, rootexpr, simplified, changed, infeasible, ownercreate, ownercreatedata)
    ccall((:SCIPsimplifyExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cuint}, Ptr{Cuint}, Ptr{Cvoid}, Ptr{Cvoid}), scip, rootexpr, simplified, changed, infeasible, ownercreate, ownercreatedata)
end

function SCIPgetSymDataExpr(scip, expr, symdata)
    ccall((:SCIPgetSymDataExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Ptr{SYM_EXPRDATA}}), scip, expr, symdata)
end

function SCIPreplaceCommonSubexpressions(scip, exprs, nexprs, replacedroot)
    ccall((:SCIPreplaceCommonSubexpressions, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Cint, Ptr{Cuint}), scip, exprs, nexprs, replacedroot)
end

function SCIPcomputeExprCurvature(scip, expr)
    ccall((:SCIPcomputeExprCurvature, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPcomputeExprIntegrality(scip, expr)
    ccall((:SCIPcomputeExprIntegrality, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPgetExprNVars(scip, expr, nvars)
    ccall((:SCIPgetExprNVars, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Cint}), scip, expr, nvars)
end

function SCIPgetExprVarExprs(scip, expr, varexprs, nvarexprs)
    ccall((:SCIPgetExprVarExprs, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cint}), scip, expr, varexprs, nvarexprs)
end

function SCIPcallExprPrint(scip, expr, stage, currentchild, parentprecedence, file)
    ccall((:SCIPcallExprPrint, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, SCIP_EXPRITER_STAGE, Cint, Cuint, Ptr{Libc.FILE}), scip, expr, stage, currentchild, parentprecedence, file)
end

function SCIPcallExprCurvature(scip, expr, exprcurvature, success, childcurv)
    ccall((:SCIPcallExprCurvature, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, SCIP_EXPRCURV, Ptr{Cuint}, Ptr{SCIP_EXPRCURV}), scip, expr, exprcurvature, success, childcurv)
end

function SCIPcallExprMonotonicity(scip, expr, childidx, result)
    ccall((:SCIPcallExprMonotonicity, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Cint, Ptr{SCIP_MONOTONE}), scip, expr, childidx, result)
end

function SCIPcallExprEval(scip, expr, childrenvalues, val)
    ccall((:SCIPcallExprEval, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Cdouble}, Ptr{Cdouble}), scip, expr, childrenvalues, val)
end

function SCIPcallExprEvalFwdiff(scip, expr, childrenvalues, direction, val, dot)
    ccall((:SCIPcallExprEvalFwdiff, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), scip, expr, childrenvalues, direction, val, dot)
end

function SCIPcallExprInteval(scip, expr, interval, intevalvar, intevalvardata)
    ccall((:SCIPcallExprInteval, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_INTERVAL}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, interval, intevalvar, intevalvardata)
end

function SCIPcallExprEstimate(scip, expr, localbounds, globalbounds, refpoint, overestimate, targetvalue, coefs, constant, islocal, success, branchcand)
    ccall((:SCIPcallExprEstimate, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_INTERVAL}, Ptr{SCIP_INTERVAL}, Ptr{Cdouble}, Cuint, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cuint}, Ptr{Cuint}, Ptr{Cuint}), scip, expr, localbounds, globalbounds, refpoint, overestimate, targetvalue, coefs, constant, islocal, success, branchcand)
end

function SCIPcallExprInitestimates(scip, expr, bounds, overestimate, coefs, constant, nreturned)
    ccall((:SCIPcallExprInitestimates, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_INTERVAL}, Cuint, Ptr{Ptr{Cdouble}}, Ptr{Cdouble}, Ptr{Cint}), scip, expr, bounds, overestimate, coefs, constant, nreturned)
end

function SCIPcallExprSimplify(scip, expr, simplifiedexpr, ownercreate, ownercreatedata)
    ccall((:SCIPcallExprSimplify, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, simplifiedexpr, ownercreate, ownercreatedata)
end

function SCIPcallExprReverseprop(scip, expr, bounds, childrenbounds, infeasible)
    ccall((:SCIPcallExprReverseprop, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, SCIP_INTERVAL, Ptr{SCIP_INTERVAL}, Ptr{Cuint}), scip, expr, bounds, childrenbounds, infeasible)
end

function SCIPcallExprGetSymData(scip, expr, symdata)
    ccall((:SCIPcallExprGetSymData, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Ptr{SYM_EXPRDATA}}), scip, expr, symdata)
end

function SCIPcreateExpriter(scip, iterator)
    ccall((:SCIPcreateExpriter, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPRITER}}), scip, iterator)
end

function SCIPfreeExpriter(iterator)
    ccall((:SCIPfreeExpriter, libscip), Cvoid, (Ptr{Ptr{SCIP_EXPRITER}},), iterator)
end

function SCIPcheckExprQuadratic(scip, expr, isquadratic)
    ccall((:SCIPcheckExprQuadratic, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Cuint}), scip, expr, isquadratic)
end

function SCIPfreeExprQuadratic(scip, expr)
    ccall((:SCIPfreeExprQuadratic, libscip), Cvoid, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPevalExprQuadratic(scip, expr, sol)
    ccall((:SCIPevalExprQuadratic, libscip), Cdouble, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_SOL}), scip, expr, sol)
end

function SCIPprintExprQuadratic(scip, expr)
    ccall((:SCIPprintExprQuadratic, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPcomputeExprQuadraticCurvature(scip, expr, curv, assumevarfixed, storeeigeninfo)
    ccall((:SCIPcomputeExprQuadraticCurvature, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_EXPRCURV}, Ptr{SCIP_HASHMAP}, Cuint), scip, expr, curv, assumevarfixed, storeeigeninfo)
end

function SCIPgetExprMonomialData(scip, expr, coef, exponents, factors)
    ccall((:SCIPgetExprMonomialData, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Ptr{SCIP_EXPR}}), scip, expr, coef, exponents, factors)
end
...
function SCIPinterruptLP(scip, interrupt)
    ccall((:SCIPinterruptLP, libscip), SCIP_RETCODE, (Ptr{SCIP}, Cuint), scip, interrupt)
end
...
function SCIPgetLPDualDegeneracy(scip, degeneracy, varconsratio)
    ccall((:SCIPgetLPDualDegeneracy, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Cdouble}, Ptr{Cdouble}), scip, degeneracy, varconsratio)
end
...
function SCIPhasNLPContinuousNonlinearity(scip, result)
    ccall((:SCIPhasNLPContinuousNonlinearity, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Cuint}), scip, result)
end
...
function SCIPgetNLPNlRowsStat(scip, nlinear, nconvexineq, nnonconvexineq, nnonlineareq)
    ccall((:SCIPgetNLPNlRowsStat, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), scip, nlinear, nconvexineq, nnonconvexineq, nnonlineareq)
end
...
function SCIPcreateNlRow(scip, nlrow, name, constant, nlinvars, linvars, lincoefs, expr, lhs, rhs, curvature)
    ccall((:SCIPcreateNlRow, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_NLROW}}, Ptr{Cchar}, Cdouble, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}, Ptr{SCIP_EXPR}, Cdouble, Cdouble, SCIP_EXPRCURV), scip, nlrow, name, constant, nlinvars, linvars, lincoefs, expr, lhs, rhs, curvature)
end
...
function SCIPsetNlRowExpr(scip, nlrow, expr)
    ccall((:SCIPsetNlRowExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLROW}, Ptr{SCIP_EXPR}), scip, nlrow, expr)
end
...
function SCIPgetNlpiSolverPointer(scip, nlpi, problem)
    ccall((:SCIPgetNlpiSolverPointer, libscip), Ptr{Cvoid}, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}), scip, nlpi, problem)
end

function SCIPcreateNlpiProblem(scip, nlpi, problem, name)
    ccall((:SCIPcreateNlpiProblem, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{Ptr{SCIP_NLPIPROBLEM}}, Ptr{Cchar}), scip, nlpi, problem, name)
end

function SCIPfreeNlpiProblem(scip, nlpi, problem)
    ccall((:SCIPfreeNlpiProblem, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{Ptr{SCIP_NLPIPROBLEM}}), scip, nlpi, problem)
end

function SCIPgetNlpiProblemPointer(scip, nlpi, problem)
    ccall((:SCIPgetNlpiProblemPointer, libscip), Ptr{Cvoid}, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}), scip, nlpi, problem)
end

function SCIPaddNlpiVars(scip, nlpi, problem, nvars, lbs, ubs, varnames)
    ccall((:SCIPaddNlpiVars, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Ptr{Cchar}}), scip, nlpi, problem, nvars, lbs, ubs, varnames)
end

function SCIPaddNlpiConstraints(scip, nlpi, problem, nconss, lhss, rhss, nlininds, lininds, linvals, exprs, names)
    ccall((:SCIPaddNlpiConstraints, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Ptr{Cint}}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{SCIP_EXPR}}, Ptr{Ptr{Cchar}}), scip, nlpi, problem, nconss, lhss, rhss, nlininds, lininds, linvals, exprs, names)
end

function SCIPsetNlpiObjective(scip, nlpi, problem, nlins, lininds, linvals, expr, constant)
    ccall((:SCIPsetNlpiObjective, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{Cint}, Ptr{Cdouble}, Ptr{SCIP_EXPR}, Cdouble), scip, nlpi, problem, nlins, lininds, linvals, expr, constant)
end

function SCIPchgNlpiVarBounds(scip, nlpi, problem, nvars, indices, lbs, ubs)
    ccall((:SCIPchgNlpiVarBounds, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}), scip, nlpi, problem, nvars, indices, lbs, ubs)
end

function SCIPchgNlpiConsSides(scip, nlpi, problem, nconss, indices, lhss, rhss)
    ccall((:SCIPchgNlpiConsSides, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}), scip, nlpi, problem, nconss, indices, lhss, rhss)
end

function SCIPdelNlpiVarSet(scip, nlpi, problem, dstats, dstatssize)
    ccall((:SCIPdelNlpiVarSet, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{Cint}, Cint), scip, nlpi, problem, dstats, dstatssize)
end

function SCIPdelNlpiConsSet(scip, nlpi, problem, dstats, dstatssize)
    ccall((:SCIPdelNlpiConsSet, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{Cint}, Cint), scip, nlpi, problem, dstats, dstatssize)
end

function SCIPchgNlpiLinearCoefs(scip, nlpi, problem, idx, nvals, varidxs, vals)
    ccall((:SCIPchgNlpiLinearCoefs, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Cint, Ptr{Cint}, Ptr{Cdouble}), scip, nlpi, problem, idx, nvals, varidxs, vals)
end

function SCIPchgNlpiExpr(scip, nlpi, problem, idxcons, expr)
    ccall((:SCIPchgNlpiExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cint, Ptr{SCIP_EXPR}), scip, nlpi, problem, idxcons, expr)
end

function SCIPchgNlpiObjConstant(scip, nlpi, problem, objconstant)
    ccall((:SCIPchgNlpiObjConstant, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Cdouble), scip, nlpi, problem, objconstant)
end

function SCIPsetNlpiInitialGuess(scip, nlpi, problem, primalvalues, consdualvalues, varlbdualvalues, varubdualvalues)
    ccall((:SCIPsetNlpiInitialGuess, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), scip, nlpi, problem, primalvalues, consdualvalues, varlbdualvalues, varubdualvalues)
end

function SCIPgetNlpiSolstat(scip, nlpi, problem)
    ccall((:SCIPgetNlpiSolstat, libscip), SCIP_NLPSOLSTAT, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}), scip, nlpi, problem)
end

function SCIPgetNlpiTermstat(scip, nlpi, problem)
    ccall((:SCIPgetNlpiTermstat, libscip), SCIP_NLPTERMSTAT, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}), scip, nlpi, problem)
end

function SCIPgetNlpiSolution(scip, nlpi, problem, primalvalues, consdualvalues, varlbdualvalues, varubdualvalues, objval)
    ccall((:SCIPgetNlpiSolution, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cdouble}}, Ptr{Cdouble}), scip, nlpi, problem, primalvalues, consdualvalues, varlbdualvalues, varubdualvalues, objval)
end

function SCIPgetNlpiStatistics(scip, nlpi, problem, statistics)
    ccall((:SCIPgetNlpiStatistics, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{SCIP_NLPSTATISTICS}), scip, nlpi, problem, statistics)
end

function SCIPcreateNlpiProblemFromNlRows(scip, nlpi, nlpiprob, name, nlrows, nnlrows, var2idx, nlrow2idx, nlscore, cutoffbound, setobj, onlyconvex)
    ccall((:SCIPcreateNlpiProblemFromNlRows, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{Ptr{SCIP_NLPIPROBLEM}}, Ptr{Cchar}, Ptr{Ptr{SCIP_NLROW}}, Cint, Ptr{SCIP_HASHMAP}, Ptr{SCIP_HASHMAP}, Ptr{Cdouble}, Cdouble, Cuint, Cuint), scip, nlpi, nlpiprob, name, nlrows, nnlrows, var2idx, nlrow2idx, nlscore, cutoffbound, setobj, onlyconvex)
end

function SCIPupdateNlpiProblem(scip, nlpi, nlpiprob, var2nlpiidx, nlpivars, nlpinvars, cutoffbound)
    ccall((:SCIPupdateNlpiProblem, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{SCIP_HASHMAP}, Ptr{Ptr{SCIP_VAR}}, Cint, Cdouble), scip, nlpi, nlpiprob, var2nlpiidx, nlpivars, nlpinvars, cutoffbound)
end

function SCIPaddNlpiProblemRows(scip, nlpi, nlpiprob, var2idx, rows, nrows)
    ccall((:SCIPaddNlpiProblemRows, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{SCIP_HASHMAP}, Ptr{Ptr{SCIP_ROW}}, Cint), scip, nlpi, nlpiprob, var2idx, rows, nrows)
end

function SCIPaddNlpiProblemNlRows(scip, nlpi, nlpiprob, var2idx, nlrows, nnlrows)
    ccall((:SCIPaddNlpiProblemNlRows, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLPI}, Ptr{SCIP_NLPIPROBLEM}, Ptr{SCIP_HASHMAP}, Ptr{Ptr{SCIP_NLROW}}, Cint), scip, nlpi, nlpiprob, var2idx, nlrows, nnlrows)
end
...
function SCIPsetParam(scip, name, value)
    ccall((:SCIPsetParam, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Cchar}, Ptr{Cchar}), scip, name, value)
end
...
function SCIPsetSepaIsParentsepa(scip, sepa)
    ccall((:SCIPsetSepaIsParentsepa, libscip), Cvoid, (Ptr{SCIP}, Ptr{SCIP_SEPA}), scip, sepa)
end

function SCIPsetSepaParentsepa(scip, sepa, parentsepa)
    ccall((:SCIPsetSepaParentsepa, libscip), Cvoid, (Ptr{SCIP}, Ptr{SCIP_SEPA}, Ptr{SCIP_SEPA}), scip, sepa, parentsepa)
end
...
function SCIPincludeCutsel(scip, name, desc, priority, cutselcopy, cutselfree, cutselinit, cutselexit, cutselinitsol, cutselexitsol, cutselselect, cutseldata)
    ccall((:SCIPincludeCutsel, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Cchar}, Ptr{Cchar}, Cint, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{SCIP_CUTSELDATA}), scip, name, desc, priority, cutselcopy, cutselfree, cutselinit, cutselexit, cutselinitsol, cutselexitsol, cutselselect, cutseldata)
end

function SCIPincludeCutselBasic(scip, cutsel, name, desc, priority, cutselselect, cutseldata)
    ccall((:SCIPincludeCutselBasic, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CUTSEL}}, Ptr{Cchar}, Ptr{Cchar}, Cint, Ptr{Cvoid}, Ptr{SCIP_CUTSELDATA}), scip, cutsel, name, desc, priority, cutselselect, cutseldata)
end

function SCIPsetCutselCopy(scip, cutsel, cutselcopy)
    ccall((:SCIPsetCutselCopy, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CUTSEL}, Ptr{Cvoid}), scip, cutsel, cutselcopy)
end

function SCIPsetCutselFree(scip, cutsel, cutselfree)
    ccall((:SCIPsetCutselFree, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CUTSEL}, Ptr{Cvoid}), scip, cutsel, cutselfree)
end

function SCIPsetCutselInit(scip, cutsel, cutselinit)
    ccall((:SCIPsetCutselInit, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CUTSEL}, Ptr{Cvoid}), scip, cutsel, cutselinit)
end

function SCIPsetCutselExit(scip, cutsel, cutselexit)
    ccall((:SCIPsetCutselExit, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CUTSEL}, Ptr{Cvoid}), scip, cutsel, cutselexit)
end

function SCIPsetCutselInitsol(scip, cutsel, cutselinitsol)
    ccall((:SCIPsetCutselInitsol, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CUTSEL}, Ptr{Cvoid}), scip, cutsel, cutselinitsol)
end

function SCIPsetCutselExitsol(scip, cutsel, cutselexitsol)
    ccall((:SCIPsetCutselExitsol, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CUTSEL}, Ptr{Cvoid}), scip, cutsel, cutselexitsol)
end

function SCIPfindCutsel(scip, name)
    ccall((:SCIPfindCutsel, libscip), Ptr{SCIP_CUTSEL}, (Ptr{SCIP}, Ptr{Cchar}), scip, name)
end
...
function SCIPsetCutselPriority(scip, cutsel, priority)
    ccall((:SCIPsetCutselPriority, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CUTSEL}, Cint), scip, cutsel, priority)
end
...
function SCIPincAvgGMIeff(scip, gmieff)
    ccall((:SCIPincAvgGMIeff, libscip), Cvoid, (Ptr{SCIP}, Cdouble), scip, gmieff)
end
...
function SCIPprintCutselectorStatistics(scip, file)
    ccall((:SCIPprintCutselectorStatistics, libscip), Cvoid, (Ptr{SCIP}, Ptr{Libc.FILE}), scip, file)
end
...
function SCIPprintExpressionHandlerStatistics(scip, file)
    ccall((:SCIPprintExpressionHandlerStatistics, libscip), Cvoid, (Ptr{SCIP}, Ptr{Libc.FILE}), scip, file)
end

function SCIPprintNLPIStatistics(scip, file)
    ccall((:SCIPprintNLPIStatistics, libscip), Cvoid, (Ptr{SCIP}, Ptr{Libc.FILE}), scip, file)
end
...
function SCIPsetClockEnabled(clck, enable)
    ccall((:SCIPsetClockEnabled, libscip), Cvoid, (Ptr{SCIP_CLOCK}, Cuint), clck, enable)
end
...
function SCIPdoNotAggrVar(scip, var)
    ccall((:SCIPdoNotAggrVar, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_VAR}), scip, var)
end
...
function SCIPmarkDoNotAggrVar(scip, var)
    ccall((:SCIPmarkDoNotAggrVar, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_VAR}), scip, var)
end
...
function SCIPgetVarAvgGMIScore(scip, var)
    ccall((:SCIPgetVarAvgGMIScore, libscip), Cdouble, (Ptr{SCIP}, Ptr{SCIP_VAR}), scip, var)
end

function SCIPincVarGMISumScore(scip, var, gmieff)
    ccall((:SCIPincVarGMISumScore, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_VAR}, Cdouble), scip, var, gmieff)
end

function SCIPgetVarLastGMIScore(scip, var)
    ccall((:SCIPgetVarLastGMIScore, libscip), Cdouble, (Ptr{SCIP}, Ptr{SCIP_VAR}), scip, var)
end

function SCIPsetVarLastGMIScore(scip, var, gmieff)
    ccall((:SCIPsetVarLastGMIScore, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_VAR}, Cdouble), scip, var, gmieff)
end
...
function SCIPincludeBranchruleGomory(scip)
    ccall((:SCIPincludeBranchruleGomory, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPcreateConsBounddisjunctionRedundant(scip, cons, name, nvars, vars, boundtypes, bounds, initial, separate, enforce, check, propagate, _local, modifiable, dynamic, removable, stickingatnode)
    ccall((:SCIPcreateConsBounddisjunctionRedundant, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_BOUNDTYPE}, Ptr{Cdouble}, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint), scip, cons, name, nvars, vars, boundtypes, bounds, initial, separate, enforce, check, propagate, _local, modifiable, dynamic, removable, stickingatnode)
end

function SCIPcreateConsBasicBounddisjunctionRedundant(scip, cons, name, nvars, vars, boundtypes, bounds)
    ccall((:SCIPcreateConsBasicBounddisjunctionRedundant, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{SCIP_BOUNDTYPE}, Ptr{Cdouble}), scip, cons, name, nvars, vars, boundtypes, bounds)
end
...
function SCIPincludeConshdlrFixedvar(scip)
    ccall((:SCIPincludeConshdlrFixedvar, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPcreateConsIndicatorGeneric(scip, cons, name, binvar, nvars, vars, vals, rhs, activeone, lessthanineq, initial, separate, enforce, check, propagate, _local, dynamic, removable, stickingatnode)
    ccall((:SCIPcreateConsIndicatorGeneric, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Ptr{SCIP_VAR}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}, Cdouble, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint), scip, cons, name, binvar, nvars, vars, vals, rhs, activeone, lessthanineq, initial, separate, enforce, check, propagate, _local, dynamic, removable, stickingatnode)
end
...
function SCIPcreateConsIndicatorGenericLinCons(scip, cons, name, binvar, lincons, slackvar, activeone, initial, separate, enforce, check, propagate, _local, dynamic, removable, stickingatnode)
    ccall((:SCIPcreateConsIndicatorGenericLinCons, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Ptr{SCIP_VAR}, Ptr{SCIP_CONS}, Ptr{SCIP_VAR}, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint), scip, cons, name, binvar, lincons, slackvar, activeone, initial, separate, enforce, check, propagate, _local, dynamic, removable, stickingatnode)
end
...
function SCIPcreateConsIndicatorGenericLinConsPure(scip, cons, name, binvar, lincons, activeone, initial, separate, enforce, check, propagate, _local, dynamic, removable, stickingatnode)
    ccall((:SCIPcreateConsIndicatorGenericLinConsPure, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Ptr{SCIP_VAR}, Ptr{SCIP_CONS}, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint), scip, cons, name, binvar, lincons, activeone, initial, separate, enforce, check, propagate, _local, dynamic, removable, stickingatnode)
end

function SCIPcreateConsIndicatorLinConsPure(scip, cons, name, binvar, lincons, initial, separate, enforce, check, propagate, _local, dynamic, removable, stickingatnode)
    ccall((:SCIPcreateConsIndicatorLinConsPure, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Ptr{SCIP_VAR}, Ptr{SCIP_CONS}, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint), scip, cons, name, binvar, lincons, initial, separate, enforce, check, propagate, _local, dynamic, removable, stickingatnode)
end
...
function SCIPgetBinaryVarIndicatorGeneric(cons)
    ccall((:SCIPgetBinaryVarIndicatorGeneric, libscip), Ptr{SCIP_VAR}, (Ptr{SCIP_CONS},), cons)
end
...
function Base.getproperty(x::Ptr{SCIP_ConsNonlinear_BilinTerm}, f::Symbol)
    ...
    f === :aux && return Ptr{__JL_Ctag_155}(x + 16)
...
function SCIPincludeConsUpgradeNonlinear(scip, nlconsupgd, priority, active, conshdlrname)
    ccall((:SCIPincludeConsUpgradeNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Cvoid}, Cint, Cuint, Ptr{Cchar}), scip, nlconsupgd, priority, active, conshdlrname)
end

function SCIPcreateConsNonlinear(scip, cons, name, expr, lhs, rhs, initial, separate, enforce, check, propagate, _local, modifiable, dynamic, removable)
    ccall((:SCIPcreateConsNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Ptr{SCIP_EXPR}, Cdouble, Cdouble, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint), scip, cons, name, expr, lhs, rhs, initial, separate, enforce, check, propagate, _local, modifiable, dynamic, removable)
end

function SCIPcreateConsBasicNonlinear(scip, cons, name, expr, lhs, rhs)
    ccall((:SCIPcreateConsBasicNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Ptr{SCIP_EXPR}, Cdouble, Cdouble), scip, cons, name, expr, lhs, rhs)
end

function SCIPcreateConsQuadraticNonlinear(scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoefs, lhs, rhs, initial, separate, enforce, check, propagate, _local, modifiable, dynamic, removable)
    ccall((:SCIPcreateConsQuadraticNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}, Cdouble, Cdouble, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint), scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoefs, lhs, rhs, initial, separate, enforce, check, propagate, _local, modifiable, dynamic, removable)
end

function SCIPcreateConsBasicQuadraticNonlinear(scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoefs, lhs, rhs)
    ccall((:SCIPcreateConsBasicQuadraticNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}, Cdouble, Cdouble), scip, cons, name, nlinvars, linvars, lincoefs, nquadterms, quadvars1, quadvars2, quadcoefs, lhs, rhs)
end

function SCIPcreateConsBasicSOCNonlinear(scip, cons, name, nvars, vars, coefs, offsets, constant, rhsvar, rhscoeff, rhsoffset)
    ccall((:SCIPcreateConsBasicSOCNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Cint, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}, Ptr{Cdouble}, Cdouble, Ptr{SCIP_VAR}, Cdouble, Cdouble), scip, cons, name, nvars, vars, coefs, offsets, constant, rhsvar, rhscoeff, rhsoffset)
end

function SCIPcreateConsBasicSignpowerNonlinear(scip, cons, name, x, z, exponent, xoffset, zcoef, lhs, rhs)
    ccall((:SCIPcreateConsBasicSignpowerNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Ptr{SCIP_VAR}, Ptr{SCIP_VAR}, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble), scip, cons, name, x, z, exponent, xoffset, zcoef, lhs, rhs)
end

function SCIPgetCurBoundsTagNonlinear(conshdlr)
    ccall((:SCIPgetCurBoundsTagNonlinear, libscip), Clonglong, (Ptr{SCIP_CONSHDLR},), conshdlr)
end

function SCIPgetLastBoundRelaxTagNonlinear(conshdlr)
    ccall((:SCIPgetLastBoundRelaxTagNonlinear, libscip), Clonglong, (Ptr{SCIP_CONSHDLR},), conshdlr)
end

function SCIPincrementCurBoundsTagNonlinear(conshdlr, boundrelax)
    ccall((:SCIPincrementCurBoundsTagNonlinear, libscip), Cvoid, (Ptr{SCIP_CONSHDLR}, Cuint), conshdlr, boundrelax)
end

function SCIPgetVarExprHashmapNonlinear(conshdlr)
    ccall((:SCIPgetVarExprHashmapNonlinear, libscip), Ptr{SCIP_HASHMAP}, (Ptr{SCIP_CONSHDLR},), conshdlr)
end

function SCIPprocessRowprepNonlinear(scip, nlhdlr, cons, expr, rowprep, overestimate, auxvar, auxvalue, allowweakcuts, branchscoresuccess, inenforcement, sol, result)
    ccall((:SCIPprocessRowprepNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLHDLR}, Ptr{SCIP_CONS}, Ptr{SCIP_EXPR}, Ptr{SCIP_ROWPREP}, Cuint, Ptr{SCIP_VAR}, Cdouble, Cuint, Cuint, Cuint, Ptr{SCIP_SOL}, Ptr{SCIP_RESULT}), scip, nlhdlr, cons, expr, rowprep, overestimate, auxvar, auxvalue, allowweakcuts, branchscoresuccess, inenforcement, sol, result)
end

function SCIPassumeConvexNonlinear(conshdlr)
    ccall((:SCIPassumeConvexNonlinear, libscip), Cuint, (Ptr{SCIP_CONSHDLR},), conshdlr)
end

function SCIPcollectBilinTermsNonlinear(scip, conshdlr, conss, nconss)
    ccall((:SCIPcollectBilinTermsNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONSHDLR}, Ptr{Ptr{SCIP_CONS}}, Cint), scip, conshdlr, conss, nconss)
end

function SCIPgetNBilinTermsNonlinear(conshdlr)
    ccall((:SCIPgetNBilinTermsNonlinear, libscip), Cint, (Ptr{SCIP_CONSHDLR},), conshdlr)
end

function SCIPgetBilinTermsNonlinear(conshdlr)
    ccall((:SCIPgetBilinTermsNonlinear, libscip), Ptr{SCIP_CONSNONLINEAR_BILINTERM}, (Ptr{SCIP_CONSHDLR},), conshdlr)
end

function SCIPgetBilinTermIdxNonlinear(conshdlr, x, y)
    ccall((:SCIPgetBilinTermIdxNonlinear, libscip), Cint, (Ptr{SCIP_CONSHDLR}, Ptr{SCIP_VAR}, Ptr{SCIP_VAR}), conshdlr, x, y)
end

function SCIPgetBilinTermNonlinear(conshdlr, x, y)
    ccall((:SCIPgetBilinTermNonlinear, libscip), Ptr{SCIP_CONSNONLINEAR_BILINTERM}, (Ptr{SCIP_CONSHDLR}, Ptr{SCIP_VAR}, Ptr{SCIP_VAR}), conshdlr, x, y)
end

function SCIPevalBilinAuxExprNonlinear(scip, x, y, auxexpr, sol)
    ccall((:SCIPevalBilinAuxExprNonlinear, libscip), Cdouble, (Ptr{SCIP}, Ptr{SCIP_VAR}, Ptr{SCIP_VAR}, Ptr{SCIP_CONSNONLINEAR_AUXEXPR}, Ptr{SCIP_SOL}), scip, x, y, auxexpr, sol)
end

function SCIPinsertBilinearTermExistingNonlinear(scip, conshdlr, x, y, auxvar, nlockspos, nlocksneg)
    ccall((:SCIPinsertBilinearTermExistingNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONSHDLR}, Ptr{SCIP_VAR}, Ptr{SCIP_VAR}, Ptr{SCIP_VAR}, Cint, Cint), scip, conshdlr, x, y, auxvar, nlockspos, nlocksneg)
end

function SCIPinsertBilinearTermImplicitNonlinear(scip, conshdlr, x, y, auxvar, coefx, coefy, coefaux, cst, overestimate)
    ccall((:SCIPinsertBilinearTermImplicitNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONSHDLR}, Ptr{SCIP_VAR}, Ptr{SCIP_VAR}, Ptr{SCIP_VAR}, Cdouble, Cdouble, Cdouble, Cdouble, Cuint), scip, conshdlr, x, y, auxvar, coefx, coefy, coefaux, cst, overestimate)
end

function SCIPcomputeFacetVertexPolyhedralNonlinear(scip, conshdlr, overestimate, _function, fundata, xstar, box, nallvars, targetvalue, success, facetcoefs, facetconstant)
    ccall((:SCIPcomputeFacetVertexPolyhedralNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONSHDLR}, Cuint, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cdouble}, Ptr{Cdouble}, Cint, Cdouble, Ptr{Cuint}, Ptr{Cdouble}, Ptr{Cdouble}), scip, conshdlr, overestimate, _function, fundata, xstar, box, nallvars, targetvalue, success, facetcoefs, facetconstant)
end

function SCIPgetExprNonlinear(cons)
    ccall((:SCIPgetExprNonlinear, libscip), Ptr{SCIP_EXPR}, (Ptr{SCIP_CONS},), cons)
end
...
function SCIPgetCurvatureNonlinear(cons)
    ccall((:SCIPgetCurvatureNonlinear, libscip), SCIP_EXPRCURV, (Ptr{SCIP_CONS},), cons)
end

function SCIPcheckQuadraticNonlinear(scip, cons, isquadratic)
    ccall((:SCIPcheckQuadraticNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{Cuint}), scip, cons, isquadratic)
end

function SCIPchgLhsNonlinear(scip, cons, lhs)
    ccall((:SCIPchgLhsNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Cdouble), scip, cons, lhs)
end

function SCIPchgRhsNonlinear(scip, cons, rhs)
    ccall((:SCIPchgRhsNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Cdouble), scip, cons, rhs)
end

function SCIPchgExprNonlinear(scip, cons, expr)
    ccall((:SCIPchgExprNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{SCIP_EXPR}), scip, cons, expr)
end
...
function SCIPaddExprNonlinear(scip, cons, expr, coef)
    ccall((:SCIPaddExprNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{SCIP_EXPR}, Cdouble), scip, cons, expr, coef)
end

function SCIPgetAbsViolationNonlinear(scip, cons, sol, viol)
    ccall((:SCIPgetAbsViolationNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{SCIP_SOL}, Ptr{Cdouble}), scip, cons, sol, viol)
end

function SCIPgetRelViolationNonlinear(scip, cons, sol, viol)
    ccall((:SCIPgetRelViolationNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{SCIP_SOL}, Ptr{Cdouble}), scip, cons, sol, viol)
end

function SCIPgetLinvarMayDecreaseNonlinear(scip, cons, var, coef)
    ccall((:SCIPgetLinvarMayDecreaseNonlinear, libscip), Cvoid, (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}), scip, cons, var, coef)
end

function SCIPgetLinvarMayIncreaseNonlinear(scip, cons, var, coef)
    ccall((:SCIPgetLinvarMayIncreaseNonlinear, libscip), Cvoid, (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{Ptr{SCIP_VAR}}, Ptr{Cdouble}), scip, cons, var, coef)
end

function SCIPgetExprNLocksPosNonlinear(expr)
    ccall((:SCIPgetExprNLocksPosNonlinear, libscip), Cint, (Ptr{SCIP_EXPR},), expr)
end

function SCIPgetExprNLocksNegNonlinear(expr)
    ccall((:SCIPgetExprNLocksNegNonlinear, libscip), Cint, (Ptr{SCIP_EXPR},), expr)
end

function SCIPgetExprAuxVarNonlinear(expr)
    ccall((:SCIPgetExprAuxVarNonlinear, libscip), Ptr{SCIP_VAR}, (Ptr{SCIP_EXPR},), expr)
end
...
function SCIPgetExprEnfoDataNonlinear(expr, idx, nlhdlr, nlhdlrexprdata, nlhdlrparticipation, sepabelowusesactivity, sepaaboveusesactivity, auxvalue)
    ccall((:SCIPgetExprEnfoDataNonlinear, libscip), Cvoid, (Ptr{SCIP_EXPR}, Cint, Ptr{Ptr{SCIP_NLHDLR}}, Ptr{Ptr{SCIP_NLHDLREXPRDATA}}, Ptr{SCIP_NLHDLR_METHOD}, Ptr{Cuint}, Ptr{Cuint}, Ptr{Cdouble}), expr, idx, nlhdlr, nlhdlrexprdata, nlhdlrparticipation, sepabelowusesactivity, sepaaboveusesactivity, auxvalue)
end

function SCIPsetExprEnfoAuxValueNonlinear(expr, idx, auxvalue)
    ccall((:SCIPsetExprEnfoAuxValueNonlinear, libscip), Cvoid, (Ptr{SCIP_EXPR}, Cint, Cdouble), expr, idx, auxvalue)
end

function SCIPgetExprNPropUsesActivityNonlinear(expr)
    ccall((:SCIPgetExprNPropUsesActivityNonlinear, libscip), Cuint, (Ptr{SCIP_EXPR},), expr)
end

function SCIPgetExprNSepaUsesActivityNonlinear(expr)
    ccall((:SCIPgetExprNSepaUsesActivityNonlinear, libscip), Cuint, (Ptr{SCIP_EXPR},), expr)
end

function SCIPgetExprNAuxvarUsesNonlinear(expr)
    ccall((:SCIPgetExprNAuxvarUsesNonlinear, libscip), Cuint, (Ptr{SCIP_EXPR},), expr)
end

function SCIPregisterExprUsageNonlinear(scip, expr, useauxvar, useactivityforprop, useactivityforsepabelow, useactivityforsepaabove)
    ccall((:SCIPregisterExprUsageNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Cuint, Cuint, Cuint, Cuint), scip, expr, useauxvar, useactivityforprop, useactivityforsepabelow, useactivityforsepaabove)
end

function SCIPgetExprActivityNonlinear(scip, cons, sol, activity)
    ccall((:SCIPgetExprActivityNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Ptr{SCIP_SOL}, Ptr{Cdouble}), scip, cons, sol, activity)
end

function SCIPgetExprAbsOrigViolationNonlinear(scip, expr, sol, soltag, viol, violunder, violover)
    ccall((:SCIPgetExprAbsOrigViolationNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_SOL}, Clonglong, Ptr{Cdouble}, Ptr{Cuint}, Ptr{Cuint}), scip, expr, sol, soltag, viol, violunder, violover)
end

function SCIPgetExprAbsAuxViolationNonlinear(scip, expr, auxvalue, sol, viol, violunder, violover)
    ccall((:SCIPgetExprAbsAuxViolationNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Cdouble, Ptr{SCIP_SOL}, Ptr{Cdouble}, Ptr{Cuint}, Ptr{Cuint}), scip, expr, auxvalue, sol, viol, violunder, violover)
end

function SCIPgetExprRelAuxViolationNonlinear(scip, expr, auxvalue, sol, viol, violunder, violover)
    ccall((:SCIPgetExprRelAuxViolationNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Cdouble, Ptr{SCIP_SOL}, Ptr{Cdouble}, Ptr{Cuint}, Ptr{Cuint}), scip, expr, auxvalue, sol, viol, violunder, violover)
end

function SCIPgetExprBoundsNonlinear(scip, expr)
    ccall((:SCIPgetExprBoundsNonlinear, libscip), SCIP_INTERVAL, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPtightenExprIntervalNonlinear(scip, expr, newbounds, cutoff, ntightenings)
    ccall((:SCIPtightenExprIntervalNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, SCIP_INTERVAL, Ptr{Cuint}, Ptr{Cint}), scip, expr, newbounds, cutoff, ntightenings)
end

function SCIPmarkExprPropagateNonlinear(scip, expr)
    ccall((:SCIPmarkExprPropagateNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPaddExprViolScoreNonlinear(scip, expr, violscore)
    ccall((:SCIPaddExprViolScoreNonlinear, libscip), Cvoid, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Cdouble), scip, expr, violscore)
end

function SCIPaddExprsViolScoreNonlinear(scip, exprs, nexprs, violscore, sol, success)
    ccall((:SCIPaddExprsViolScoreNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Cint, Cdouble, Ptr{SCIP_SOL}, Ptr{Cuint}), scip, exprs, nexprs, violscore, sol, success)
end

function SCIPgetExprViolScoreNonlinear(expr)
    ccall((:SCIPgetExprViolScoreNonlinear, libscip), Cdouble, (Ptr{SCIP_EXPR},), expr)
end

function SCIPgetExprPartialDiffNonlinear(scip, expr, var)
    ccall((:SCIPgetExprPartialDiffNonlinear, libscip), Cdouble, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_VAR}), scip, expr, var)
end

function SCIPgetExprPartialDiffGradientDirNonlinear(scip, expr, var)
    ccall((:SCIPgetExprPartialDiffGradientDirNonlinear, libscip), Cdouble, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_VAR}), scip, expr, var)
end

function SCIPevalExprQuadraticAuxNonlinear(scip, expr, sol)
    ccall((:SCIPevalExprQuadraticAuxNonlinear, libscip), Cdouble, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_SOL}), scip, expr, sol)
end

function SCIPincludeNlhdlrNonlinear(scip, nlhdlr, name, desc, detectpriority, enfopriority, detect, evalaux, nlhdlrdata)
    ccall((:SCIPincludeNlhdlrNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_NLHDLR}}, Ptr{Cchar}, Ptr{Cchar}, Cint, Cint, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{SCIP_NLHDLRDATA}), scip, nlhdlr, name, desc, detectpriority, enfopriority, detect, evalaux, nlhdlrdata)
end

function SCIPgetNNlhdlrsNonlinear(conshdlr)
    ccall((:SCIPgetNNlhdlrsNonlinear, libscip), Cint, (Ptr{SCIP_CONSHDLR},), conshdlr)
end

function SCIPgetNlhdlrsNonlinear(conshdlr)
    ccall((:SCIPgetNlhdlrsNonlinear, libscip), Ptr{Ptr{SCIP_NLHDLR}}, (Ptr{SCIP_CONSHDLR},), conshdlr)
end

function SCIPfindNlhdlrNonlinear(conshdlr, name)
    ccall((:SCIPfindNlhdlrNonlinear, libscip), Ptr{SCIP_NLHDLR}, (Ptr{SCIP_CONSHDLR}, Ptr{Cchar}), conshdlr, name)
end

function SCIPgetNlhdlrExprDataNonlinear(nlhdlr, expr)
    ccall((:SCIPgetNlhdlrExprDataNonlinear, libscip), Ptr{SCIP_NLHDLREXPRDATA}, (Ptr{SCIP_NLHDLR}, Ptr{SCIP_EXPR}), nlhdlr, expr)
end
...
function SCIPcreateConsOrbitope(scip, cons, name, vars, orbitopetype, nspcons, nblocks, usedynamicprop, mayinteract, resolveprop, ismodelcons, initial, separate, enforce, check, propagate, _local, modifiable, dynamic, removable, stickingatnode)
    ccall((:SCIPcreateConsOrbitope, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Ptr{Ptr{Ptr{SCIP_VAR}}}, SCIP_ORBITOPETYPE, Cint, Cint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint), scip, cons, name, vars, orbitopetype, nspcons, nblocks, usedynamicprop, mayinteract, resolveprop, ismodelcons, initial, separate, enforce, check, propagate, _local, modifiable, dynamic, removable, stickingatnode)
end

function SCIPcreateConsBasicOrbitope(scip, cons, name, vars, orbitopetype, nspcons, nblocks, usedynamicprop, resolveprop, ismodelcons, mayinteract)
    ccall((:SCIPcreateConsBasicOrbitope, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_CONS}}, Ptr{Cchar}, Ptr{Ptr{Ptr{SCIP_VAR}}}, SCIP_ORBITOPETYPE, Cint, Cint, Cuint, Cuint, Cuint, Cuint), scip, cons, name, vars, orbitopetype, nspcons, nblocks, usedynamicprop, resolveprop, ismodelcons, mayinteract)
end
...
function SCIPdialogExecMenu(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecMenu, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecMenuLazy(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecMenuLazy, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecChangeAddCons(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecChangeAddCons, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecChangeBounds(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecChangeBounds, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecChangeFreetransproblem(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecChangeFreetransproblem, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecChangeObjSense(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecChangeObjSense, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecChecksol(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecChecksol, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecCliquegraph(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecCliquegraph, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayBenders(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayBenders, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayBranching(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayBranching, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayCompression(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayCompression, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayConflict(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayConflict, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayConshdlrs(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayConshdlrs, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayDisplaycols(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayDisplaycols, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayExprhdlrs(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayExprhdlrs, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayCutselectors(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayCutselectors, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayHeuristics(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayHeuristics, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayMemory(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayMemory, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayNodeselectors(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayNodeselectors, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayNlpi(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayNlpi, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayParameters(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayParameters, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayPresolvers(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayPresolvers, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayPricers(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayPricers, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayProblem(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayProblem, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayPropagators(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayPropagators, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayReaders(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayReaders, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayRelaxators(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayRelaxators, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplaySeparators(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplaySeparators, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplaySolution(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplaySolution, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayFiniteSolution(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayFiniteSolution, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayDualSolution(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayDualSolution, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplaySolutionPool(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplaySolutionPool, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplaySubproblem(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplaySubproblem, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplaySubSolution(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplaySubSolution, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayStatistics(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayStatistics, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayReoptStatistics(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayReoptStatistics, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayTransproblem(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayTransproblem, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayValue(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayValue, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayVarbranchstatistics(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayVarbranchstatistics, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayLPSolutionQuality(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayLPSolutionQuality, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayTranssolution(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayTranssolution, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecHelp(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecHelp, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecFree(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecFree, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecNewstart(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecNewstart, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecTransform(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecTransform, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecOptimize(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecOptimize, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecConcurrentOpt(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecConcurrentOpt, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecPresolve(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecPresolve, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecQuit(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecQuit, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecRead(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecRead, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetDefault(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetDefault, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetLoad(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetLoad, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetSave(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetSave, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetDiffsave(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetDiffsave, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetParam(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetParam, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogDescSetParam(scip, dialog)
    ccall((:SCIPdialogDescSetParam, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}), scip, dialog)
end

function SCIPdialogExecFixParam(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecFixParam, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogDescFixParam(scip, dialog)
    ccall((:SCIPdialogDescFixParam, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}), scip, dialog)
end

function SCIPdialogExecSetBranchingDirection(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetBranchingDirection, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetBranchingPriority(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetBranchingPriority, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetHeuristicsAggressive(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetHeuristicsAggressive, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetHeuristicsDefault(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetHeuristicsDefault, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetHeuristicsFast(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetHeuristicsFast, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetHeuristicsOff(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetHeuristicsOff, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetPresolvingAggressive(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetPresolvingAggressive, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetPresolvingDefault(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetPresolvingDefault, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetPresolvingFast(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetPresolvingFast, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetPresolvingOff(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetPresolvingOff, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetSeparatingAggressive(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetSeparatingAggressive, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetSeparatingDefault(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetSeparatingDefault, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetSeparatingFast(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetSeparatingFast, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetSeparatingOff(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetSeparatingOff, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetEmphasisCounter(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetEmphasisCounter, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetEmphasisCpsolver(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetEmphasisCpsolver, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetEmphasisEasycip(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetEmphasisEasycip, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetEmphasisFeasibility(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetEmphasisFeasibility, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetEmphasisHardlp(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetEmphasisHardlp, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetEmphasisOptimality(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetEmphasisOptimality, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetEmphasisNumerics(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetEmphasisNumerics, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetEmphasisBenchmark(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetEmphasisBenchmark, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecSetLimitsObjective(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecSetLimitsObjective, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPdialogExecDisplayLinearConsClassification(scip, dialog, dialoghdlr, nextdialog)
    ccall((:SCIPdialogExecDisplayLinearConsClassification, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_DIALOG}, Ptr{SCIP_DIALOGHDLR}, Ptr{Ptr{SCIP_DIALOG}}), scip, dialog, dialoghdlr, nextdialog)
end

function SCIPcreateRootDialog(scip, root)
    ccall((:SCIPcreateRootDialog, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_DIALOG}}), scip, root)
end

function SCIPincludeDialogDefaultBasic(scip)
    ccall((:SCIPincludeDialogDefaultBasic, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPincludeDialogDefaultSet(scip)
    ccall((:SCIPincludeDialogDefaultSet, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPincludeDialogDefaultFix(scip)
    ccall((:SCIPincludeDialogDefaultFix, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPcreateExprAbs(scip, expr, child, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprAbs, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPR}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, child, ownercreate, ownercreatedata)
end

function SCIPisExprAbs(scip, expr)
    ccall((:SCIPisExprAbs, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end
...
function SCIPincludeExprhdlrEntropy(scip)
    ccall((:SCIPincludeExprhdlrEntropy, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPcreateExprEntropy(scip, expr, child, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprEntropy, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPR}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, child, ownercreate, ownercreatedata)
end

function SCIPisExprEntropy(scip, expr)
    ccall((:SCIPisExprEntropy, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPcreateExprExp(scip, expr, child, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprExp, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPR}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, child, ownercreate, ownercreatedata)
end

function SCIPisExprExp(scip, expr)
    ccall((:SCIPisExprExp, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end
...
function SCIPcreateExprLog(scip, expr, child, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprLog, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPR}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, child, ownercreate, ownercreatedata)
end

function SCIPisExprLog(scip, expr)
    ccall((:SCIPisExprLog, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end
...
function SCIPcreateExprPow(scip, expr, child, exponent, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprPow, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPR}, Cdouble, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, child, exponent, ownercreate, ownercreatedata)
end

function SCIPcreateExprSignpower(scip, expr, child, exponent, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprSignpower, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPR}, Cdouble, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, child, exponent, ownercreate, ownercreatedata)
end

function SCIPisExprSignpower(scip, expr)
    ccall((:SCIPisExprSignpower, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end
...
function SCIPincludeExprhdlrSignpower(scip)
    ccall((:SCIPincludeExprhdlrSignpower, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPaddSquareSecant(scip, sqrcoef, lb, ub, lincoef, linconstant, success)
    ccall((:SCIPaddSquareSecant, libscip), Cvoid, (Ptr{SCIP}, Cdouble, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cuint}), scip, sqrcoef, lb, ub, lincoef, linconstant, success)
end

function SCIPestimateRoot(scip, exponent, overestimate, xlb, xub, xref, constant, slope, islocal, success)
    ccall((:SCIPestimateRoot, libscip), Cvoid, (Ptr{SCIP}, Cdouble, Cuint, Cdouble, Cdouble, Cdouble, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cuint}, Ptr{Cuint}), scip, exponent, overestimate, xlb, xub, xref, constant, slope, islocal, success)
end

function SCIPincludeExprhdlrProduct(scip)
    ccall((:SCIPincludeExprhdlrProduct, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPcreateExprProduct(scip, expr, nchildren, children, coefficient, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprProduct, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Cint, Ptr{Ptr{SCIP_EXPR}}, Cdouble, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, nchildren, children, coefficient, ownercreate, ownercreatedata)
end
...
function SCIPcreateExprSum(scip, expr, nchildren, children, coefficients, constant, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprSum, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Cint, Ptr{Ptr{SCIP_EXPR}}, Ptr{Cdouble}, Cdouble, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, nchildren, children, coefficients, constant, ownercreate, ownercreatedata)
end

function SCIPsetConstantExprSum(expr, constant)
    ccall((:SCIPsetConstantExprSum, libscip), Cvoid, (Ptr{SCIP_EXPR}, Cdouble), expr, constant)
end

function SCIPappendExprSumExpr(scip, expr, child, childcoef)
    ccall((:SCIPappendExprSumExpr, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, Ptr{SCIP_EXPR}, Cdouble), scip, expr, child, childcoef)
end

function SCIPmultiplyByConstantExprSum(expr, constant)
    ccall((:SCIPmultiplyByConstantExprSum, libscip), Cvoid, (Ptr{SCIP_EXPR}, Cdouble), expr, constant)
end

function SCIPmultiplyBySumExprSum(scip, product, factor1, factor2, simplify, ownercreate, ownercreatedata)
    ccall((:SCIPmultiplyBySumExprSum, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPR}, Ptr{SCIP_EXPR}, Cuint, Ptr{Cvoid}, Ptr{Cvoid}), scip, product, factor1, factor2, simplify, ownercreate, ownercreatedata)
end

function SCIPpowerExprSum(scip, result, base, exponent, simplify, ownercreate, ownercreatedata)
    ccall((:SCIPpowerExprSum, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPR}, Cint, Cuint, Ptr{Cvoid}, Ptr{Cvoid}), scip, result, base, exponent, simplify, ownercreate, ownercreatedata)
end
...
function SCIPcreateExprSin(scip, expr, child, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprSin, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPR}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, child, ownercreate, ownercreatedata)
end

function SCIPcreateExprCos(scip, expr, child, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprCos, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_EXPR}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, child, ownercreate, ownercreatedata)
end

function SCIPisExprSin(scip, expr)
    ccall((:SCIPisExprSin, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPisExprCos(scip, expr)
    ccall((:SCIPisExprCos, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end

function SCIPincludeExprhdlrValue(scip)
    ccall((:SCIPincludeExprhdlrValue, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPcreateExprValue(scip, expr, value, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprValue, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Cdouble, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, value, ownercreate, ownercreatedata)
end
...
function SCIPcreateExprVar(scip, expr, var, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprVar, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Ptr{SCIP_VAR}, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, var, ownercreate, ownercreatedata)
end
...
function SCIPincludeHeurIndicatordiving(scip)
    ccall((:SCIPincludeHeurIndicatordiving, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPincludeHeurScheduler(scip)
    ccall((:SCIPincludeHeurScheduler, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPapplyHeurSubNlp(scip, heur, result, refpoint, resultsol)
    ccall((:SCIPapplyHeurSubNlp, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_HEUR}, Ptr{SCIP_RESULT}, Ptr{SCIP_SOL}, Ptr{SCIP_SOL}), scip, heur, result, refpoint, resultsol)
end
...
function SCIPcomputeCoverUndercover(scip, coversize, cover, timelimit, memorylimit, objlimit, globalbounds, onlyconvexify, coverand, coverbd, coverind, covernl, coveringobj, success)
    ccall((:SCIPcomputeCoverUndercover, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Cint}, Ptr{Ptr{SCIP_VAR}}, Cdouble, Cdouble, Cdouble, Cuint, Cuint, Cuint, Cuint, Cuint, Cuint, Cchar, Ptr{Cuint}), scip, coversize, cover, timelimit, memorylimit, objlimit, globalbounds, onlyconvexify, coverand, coverbd, coverind, covernl, coveringobj, success)
end
...
function SCIPincludeNlhdlrBilinear(scip)
    ccall((:SCIPincludeNlhdlrBilinear, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPgetExprsBilinear(nlhdlr)
    ccall((:SCIPgetExprsBilinear, libscip), Ptr{Ptr{SCIP_EXPR}}, (Ptr{SCIP_NLHDLR},), nlhdlr)
end

function SCIPgetExprsdataBilinear(nlhdlr)
    ccall((:SCIPgetExprsdataBilinear, libscip), Ptr{Ptr{SCIP_NLHDLREXPRDATA}}, (Ptr{SCIP_NLHDLR},), nlhdlr)
end
...
function SCIPaddIneqBilinear(scip, nlhdlr, expr, xcoef, ycoef, constant, success)
    ccall((:SCIPaddIneqBilinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLHDLR}, Ptr{SCIP_EXPR}, Cdouble, Cdouble, Cdouble, Ptr{Cuint}), scip, nlhdlr, expr, xcoef, ycoef, constant, success)
end
...
function SCIPincludeNlhdlrConcave(scip)
    ccall((:SCIPincludeNlhdlrConcave, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPhasExprCurvature(scip, expr, curv, success, assumevarfixed)
    ccall((:SCIPhasExprCurvature, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_EXPR}, SCIP_EXPRCURV, Ptr{Cuint}, Ptr{SCIP_HASHMAP}), scip, expr, curv, success, assumevarfixed)
end

function SCIPincludeNlhdlrDefault(scip)
    ccall((:SCIPincludeNlhdlrDefault, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPincludeNlhdlrPerspective(scip)
    ccall((:SCIPincludeNlhdlrPerspective, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPincludeNlhdlrQuadratic(scip)
    ccall((:SCIPincludeNlhdlrQuadratic, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPincludeNlhdlrQuotient(scip)
    ccall((:SCIPincludeNlhdlrQuotient, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPincludeNlhdlrSignomial(scip)
    ccall((:SCIPincludeNlhdlrSignomial, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPisSOCNonlinear(scip, cons, compeigenvalues, success, sidetype, vars, offsets, transcoefs, transcoefsidx, termbegins, nvars, nterms)
    ccall((:SCIPisSOCNonlinear, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_CONS}, Cuint, Ptr{Cuint}, Ptr{SCIP_SIDETYPE}, Ptr{Ptr{Ptr{SCIP_VAR}}}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cint}}, Ptr{Ptr{Cint}}, Ptr{Cint}, Ptr{Cint}), scip, cons, compeigenvalues, success, sidetype, vars, offsets, transcoefs, transcoefsidx, termbegins, nvars, nterms)
end

function SCIPfreeSOCArraysNonlinear(scip, vars, offsets, transcoefs, transcoefsidx, termbegins, nvars, nterms)
    ccall((:SCIPfreeSOCArraysNonlinear, libscip), Cvoid, (Ptr{SCIP}, Ptr{Ptr{Ptr{SCIP_VAR}}}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cdouble}}, Ptr{Ptr{Cint}}, Ptr{Ptr{Cint}}, Cint, Cint), scip, vars, offsets, transcoefs, transcoefsidx, termbegins, nvars, nterms)
end
...
function SCIPcreateSymOpNodeType(scip, opnodename, nodetype)
    ccall((:SCIPcreateSymOpNodeType, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Cchar}, Ptr{Cint}), scip, opnodename, nodetype)
end

function SCIPgetSymOpNodeType(scip, opnodename, nodetype)
    ccall((:SCIPgetSymOpNodeType, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Cchar}, Ptr{Cint}), scip, opnodename, nodetype)
end
...
function SCIPincludeSepaInterminor(scip)
    ccall((:SCIPincludeSepaInterminor, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPincludeSepaLagromory(scip)
    ccall((:SCIPincludeSepaLagromory, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPcomputeOrbitsSym(scip, issigned, permvars, npermvars, perms, nperms, orbits, orbitbegins, norbits)
    ccall((:SCIPcomputeOrbitsSym, libscip), SCIP_RETCODE, (Ptr{SCIP}, Cuint, Ptr{Ptr{SCIP_VAR}}, Cint, Ptr{Ptr{Cint}}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), scip, issigned, permvars, npermvars, perms, nperms, orbits, orbitbegins, norbits)
end

function SCIPcomputeOrbitsFilterSym(scip, npermvars, permstrans, nperms, inactiveperms, orbits, orbitbegins, norbits, components, componentbegins, vartocomponent, componentblocked, ncomponents, nmovedpermvars)
    ccall((:SCIPcomputeOrbitsFilterSym, libscip), SCIP_RETCODE, (Ptr{SCIP}, Cint, Ptr{Ptr{Cint}}, Cint, Ptr{UInt8}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cuint}, Cint, Cint), scip, npermvars, permstrans, nperms, inactiveperms, orbits, orbitbegins, norbits, components, componentbegins, vartocomponent, componentblocked, ncomponents, nmovedpermvars)
end

function SCIPcomputeOrbitsComponentsSym(scip, npermvars, permstrans, nperms, components, componentbegins, vartocomponent, ncomponents, orbits, orbitbegins, norbits, varorbitmap)
    ccall((:SCIPcomputeOrbitsComponentsSym, libscip), SCIP_RETCODE, (Ptr{SCIP}, Cint, Ptr{Ptr{Cint}}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), scip, npermvars, permstrans, nperms, components, componentbegins, vartocomponent, ncomponents, orbits, orbitbegins, norbits, varorbitmap)
end

function SCIPcomputeOrbitVar(scip, npermvars, perms, permstrans, components, componentbegins, ignoredvars, varfound, varidx, component, orbit, orbitsize)
    ccall((:SCIPcomputeOrbitVar, libscip), SCIP_RETCODE, (Ptr{SCIP}, Cint, Ptr{Ptr{Cint}}, Ptr{Ptr{Cint}}, Ptr{Cint}, Ptr{Cint}, Ptr{UInt8}, Ptr{UInt8}, Cint, Cint, Ptr{Cint}, Ptr{Cint}), scip, npermvars, perms, permstrans, components, componentbegins, ignoredvars, varfound, varidx, component, orbit, orbitsize)
end

function SCIPisInvolutionPerm(perm, vars, nvars, ntwocyclesperm, nbincyclesperm, earlytermination)
    ccall((:SCIPisInvolutionPerm, libscip), SCIP_RETCODE, (Ptr{Cint}, Ptr{Ptr{SCIP_VAR}}, Cint, Ptr{Cint}, Ptr{Cint}, Cuint), perm, vars, nvars, ntwocyclesperm, nbincyclesperm, earlytermination)
end

function SCIPdetermineNVarsAffectedSym(scip, perms, nperms, permvars, npermvars, nvarsaffected)
    ccall((:SCIPdetermineNVarsAffectedSym, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{Cint}}, Cint, Ptr{Ptr{SCIP_VAR}}, Cint, Ptr{Cint}), scip, perms, nperms, permvars, npermvars, nvarsaffected)
end

function SCIPcomputeComponentsSym(scip, symtype, perms, nperms, permvars, npermvars, transposed, components, componentbegins, vartocomponent, componentblocked, ncomponents)
...
function SCIPextendSubOrbitope(suborbitope, nrows, nfilledcols, coltoextend, perm, leftextension, nusedelems, permvars, rowisbinary, success, infeasible)
    ccall((:SCIPextendSubOrbitope, libscip), SCIP_RETCODE, (Ptr{Ptr{Cint}}, Cint, Cint, Cint, Ptr{Cint}, Cuint, Ptr{Ptr{Cint}}, Ptr{Ptr{SCIP_VAR}}, Ptr{UInt8}, Ptr{Cuint}, Ptr{Cuint}), suborbitope, nrows, nfilledcols, coltoextend, perm, leftextension, nusedelems, permvars, rowisbinary, success, infeasible)
end

function SCIPgenerateOrbitopeVarsMatrix(scip, vars, nrows, ncols, permvars, npermvars, orbitopevaridx, columnorder, nusedelems, rowisbinary, infeasible, storelexorder, lexorder, nvarsorder, maxnvarsorder)
    ccall((:SCIPgenerateOrbitopeVarsMatrix, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{Ptr{Ptr{SCIP_VAR}}}}, Cint, Cint, Ptr{Ptr{SCIP_VAR}}, Cint, Ptr{Ptr{Cint}}, Ptr{Cint}, Ptr{Cint}, Ptr{UInt8}, Ptr{Cuint}, Cuint, Ptr{Ptr{Cint}}, Ptr{Cint}, Ptr{Cint}), scip, vars, nrows, ncols, permvars, npermvars, orbitopevaridx, columnorder, nusedelems, rowisbinary, infeasible, storelexorder, lexorder, nvarsorder, maxnvarsorder)
end

function SCIPisPackingPartitioningOrbitope(scip, vars, nrows, ncols, pprows, npprows, type)
    ccall((:SCIPisPackingPartitioningOrbitope, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{Ptr{SCIP_VAR}}}, Cint, Cint, Ptr{Ptr{Cuint}}, Ptr{Cint}, Ptr{SCIP_ORBITOPETYPE}), scip, vars, nrows, ncols, pprows, npprows, type)
end

function SCIPdetectSingleOrDoubleLexMatrices(scip, detectsinglelex, perms, nperms, permlen, success, isorbitope, lexmatrix, nrows, ncols, lexrowsbegin, lexcolsbegin, nrowmatrices, ncolmatrices)
    ccall((:SCIPdetectSingleOrDoubleLexMatrices, libscip), SCIP_RETCODE, (Ptr{SCIP}, Cuint, Ptr{Ptr{Cint}}, Cint, Cint, Ptr{Cuint}, Ptr{Cuint}, Ptr{Ptr{Ptr{Cint}}}, Ptr{Cint}, Ptr{Cint}, Ptr{Ptr{Cint}}, Ptr{Ptr{Cint}}, Ptr{Cint}, Ptr{Cint}), scip, detectsinglelex, perms, nperms, permlen, success, isorbitope, lexmatrix, nrows, ncols, lexrowsbegin, lexcolsbegin, nrowmatrices, ncolmatrices)
end

function SCIPsymEQ(scip, val1, val2)
    ccall((:SCIPsymEQ, libscip), Cuint, (Ptr{SCIP}, Cdouble, Cdouble), scip, val1, val2)
end

function SCIPsymLE(scip, val1, val2)
    ccall((:SCIPsymLE, libscip), Cuint, (Ptr{SCIP}, Cdouble, Cdouble), scip, val1, val2)
end

function SCIPsymGE(scip, val1, val2)
    ccall((:SCIPsymGE, libscip), Cuint, (Ptr{SCIP}, Cdouble, Cdouble), scip, val1, val2)
end

function SCIPsymLT(scip, val1, val2)
    ccall((:SCIPsymLT, libscip), Cuint, (Ptr{SCIP}, Cdouble, Cdouble), scip, val1, val2)
end

function SCIPsymGT(scip, val1, val2)
    ccall((:SCIPsymGT, libscip), Cuint, (Ptr{SCIP}, Cdouble, Cdouble), scip, val1, val2)
end
...
function SCIPselectCutsHybrid(scip, cuts, forcedcuts, randnumgen, goodscorefac, badscorefac, goodmaxparall, maxparall, dircutoffdistweight, efficacyweight, objparalweight, intsupportweight, ncuts, nforcedcuts, maxselectedcuts, nselectedcuts)
    ccall((:SCIPselectCutsHybrid, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_ROW}}, Ptr{Ptr{SCIP_ROW}}, Ptr{SCIP_RANDNUMGEN}, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cint, Cint, Cint, Ptr{Cint}), scip, cuts, forcedcuts, randnumgen, goodscorefac, badscorefac, goodmaxparall, maxparall, dircutoffdistweight, efficacyweight, objparalweight, intsupportweight, ncuts, nforcedcuts, maxselectedcuts, nselectedcuts)
end

function SCIPincludeCutselDynamic(scip)
    ccall((:SCIPincludeCutselDynamic, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPselectCutsDynamic(scip, cuts, forcedcuts, randnumgen, filtermode, mingain, maxparall, dircutoffdistweight, efficacyweight, objparalweight, intsupportweight, ncuts, nforcedcuts, maxselectedcuts, nselectedcuts)
    ccall((:SCIPselectCutsDynamic, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_ROW}}, Ptr{Ptr{SCIP_ROW}}, Ptr{SCIP_RANDNUMGEN}, Cchar, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cdouble, Cint, Cint, Cint, Ptr{Cint}), scip, cuts, forcedcuts, randnumgen, filtermode, mingain, maxparall, dircutoffdistweight, efficacyweight, objparalweight, intsupportweight, ncuts, nforcedcuts, maxselectedcuts, nselectedcuts)
end

function SCIPincludeCutselEnsemble(scip)
    ccall((:SCIPincludeCutselEnsemble, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPselectCutsEnsemble(scip, cuts, forcedcuts, cutseldata, root, ncuts, nforcedcuts, maxselectedcuts, nselectedcuts)
    ccall((:SCIPselectCutsEnsemble, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_ROW}}, Ptr{Ptr{SCIP_ROW}}, Ptr{SCIP_CUTSELDATA}, Cuint, Cint, Cint, Cint, Ptr{Cint}), scip, cuts, forcedcuts, cutseldata, root, ncuts, nforcedcuts, maxselectedcuts, nselectedcuts)
end

function SCIPincludeExprhdlrVaridx(scip)
    ccall((:SCIPincludeExprhdlrVaridx, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end

function SCIPcreateExprVaridx(scip, expr, varidx, ownercreate, ownercreatedata)
    ccall((:SCIPcreateExprVaridx, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_EXPR}}, Cint, Ptr{Cvoid}, Ptr{Cvoid}), scip, expr, varidx, ownercreate, ownercreatedata)
end

function SCIPisExprVaridx(scip, expr)
    ccall((:SCIPisExprVaridx, libscip), Cuint, (Ptr{SCIP}, Ptr{SCIP_EXPR}), scip, expr)
end
...
function SCIPsetIndexExprVaridx(expr, newindex)
    ccall((:SCIPsetIndexExprVaridx, libscip), Cvoid, (Ptr{SCIP_EXPR}, Cint), expr, newindex)
end

function SCIPincludeNlpSolverIpopt(scip)
    ccall((:SCIPincludeNlpSolverIpopt, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPcallLapackDsyevIpopt(computeeigenvectors, N, a, w)
    ccall((:SCIPcallLapackDsyevIpopt, libscip), SCIP_RETCODE, (Cuint, Cint, Ptr{Cdouble}, Ptr{Cdouble}), computeeigenvectors, N, a, w)
end

function SCIPsolveLinearEquationsIpopt(N, A, b, x, success)
    ccall((:SCIPsolveLinearEquationsIpopt, libscip), SCIP_RETCODE, (Cint, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cuint}), N, A, b, x, success)
end

function SCIPincludeNlpSolverFilterSQP(scip)
    ccall((:SCIPincludeNlpSolverFilterSQP, libscip), SCIP_RETCODE, (Ptr{SCIP},), scip)
end
...
function SCIPincludeNlpSolverWorhp(scip, useip)
    ccall((:SCIPincludeNlpSolverWorhp, libscip), SCIP_RETCODE, (Ptr{SCIP}, Cuint), scip, useip)
end
...
function SCIPlpiInterrupt(lpi, interrupt)
    ccall((:SCIPlpiInterrupt, libscip), SCIP_RETCODE, (Ptr{SCIP_LPI}, Cuint), lpi, interrupt)
end
...
const SCIP_EXPRITER_ALLSTAGES = ((SCIP_EXPRITER_ENTEREXPR | SCIP_EXPRITER_VISITINGCHILD) | SCIP_EXPRITER_VISITEDCHILD) | SCIP_EXPRITER_LEAVEEXPR
...
const SCIP_EXPRPRINT_ALL = ((((SCIP_EXPRPRINT_EXPRSTRING | SCIP_EXPRPRINT_EXPRHDLR) | SCIP_EXPRPRINT_NUSES) | SCIP_EXPRPRINT_EVALTAG) | SCIP_EXPRPRINT_ACTIVITYTAG) | SCIP_EXPRPRINT_OWNER
...
const SCIP_EXPRINTCAPABILITY_ALL = (SCIP_EXPRINTCAPABILITY_FUNCVALUE | SCIP_EXPRINTCAPABILITY_GRADIENT) | SCIP_EXPRINTCAPABILITY_HESSIAN
...
const SCIP_NLHDLR_METHOD_ALL = SCIP_NLHDLR_METHOD_SEPABOTH | SCIP_NLHDLR_METHOD_ACTIVITY
...
const SCIP_VERSION_MAJOR = 9

const SCIP_VERSION_MINOR = 2

const SCIP_VERSION_PATCH = 1

const SCIP_VERSION = 100SCIP_VERSION_MAJOR + 10SCIP_VERSION_MINOR + SCIP_VERSION_PATCH

const SCIP_VERSION_SUB = 0

const SCIP_SUBVERSION = SCIP_VERSION_SUB

const SCIP_VERSION_API = 115
