...
function SCIPgetNlhdlrBilinearExprs(nlhdlr)
    ccall((:SCIPgetNlhdlrBilinearExprs, libscip), Ptr{Ptr{SCIP_EXPR}}, (Ptr{SCIP_NLHDLR},), nlhdlr)
end

function SCIPgetNlhdlrBilinearExprsdata(nlhdlr)
    ccall((:SCIPgetNlhdlrBilinearExprsdata, libscip), Ptr{Ptr{SCIP_NLHDLREXPRDATA}}, (Ptr{SCIP_NLHDLR},), nlhdlr)
end

function SCIPgetNlhdlrBilinearNExprs(nlhdlr)
    ccall((:SCIPgetNlhdlrBilinearNExprs, libscip), Cint, (Ptr{SCIP_NLHDLR},), nlhdlr)
end

function SCIPaddNlhdlrBilinearIneq(scip, nlhdlr, expr, xcoef, ycoef, constant, success)
    ccall((:SCIPaddNlhdlrBilinearIneq, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{SCIP_NLHDLR}, Ptr{SCIP_EXPR}, Cdouble, Cdouble, Cdouble, Ptr{Cuint}), scip, nlhdlr, expr, xcoef, ycoef, constant, success)
end
...
function SCIPcomputeOrbitsSym(scip, permvars, npermvars, perms, nperms, orbits, orbitbegins, norbits)
    ccall((:SCIPcomputeOrbitsSym, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{SCIP_VAR}}, Cint, Ptr{Ptr{Cint}}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), scip, permvars, npermvars, perms, nperms, orbits, orbitbegins, norbits)
end
...
function SCIPcomputeComponentsSym(scip, perms, nperms, permvars, npermvars, transposed, components, componentbegins, vartocomponent, componentblocked, ncomponents)
    ccall((:SCIPcomputeComponentsSym, libscip), SCIP_RETCODE, (Ptr{SCIP}, Ptr{Ptr{Cint}}, Cint, Ptr{Ptr{SCIP_VAR}}, Cint, Cuint, Ptr{Ptr{Cint}}, Ptr{Ptr{Cint}}, Ptr{Ptr{Cint}}, Ptr{Ptr{Cuint}}, Ptr{Cint}), scip, perms, nperms, permvars, npermvars, transposed, components, componentbegins, vartocomponent, componentblocked, ncomponents)
end
